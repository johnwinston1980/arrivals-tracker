...
/*jshint ignore:start*/
(function () {
    function na(m, s) { m.prototype = $a(s.prototype); m.prototype.constructor = m; m.base = s.prototype; }
    function $a(m) { function s() { } s.prototype = m; return new s; }
    function Ta(m, s, q) {
    ...
    function ha(m, s) { var q = !1; 0 > m && (q = !0, m *= -1); m = "" + m; for (s = s ? s : 1; m.length < s;)
        m = "0" + m; return q ? "-" + m : m; }
    function Fa(m) { if (!m)
        return m; m = m.replace(/^\s\s*/, ""); for (var s = /\s/, q = m.length; s.test(m.charAt(--q));)
    ...
    function Pa(m, s) { return m - s; }
    function R(m) { var s = ((m & 16711680) >> 16).toString(16), q = ((m & 65280) >> 8).toString(16); m = ((m & 255) >> 0).toString(16); s = 2 > s.length ? "0" + s : s; q = 2 > q.length ? "0" + q : q; m = 2 > m.length ? "0" + m : m; return "#" + s + q + m; }
    function ab(m, s) {
    ...
    function Ca(m) { m.indexOf || (m.indexOf = ab); return m; }
    function bb(m) { if (W.fSDec)
        m[ga("`eeDwdouMhrudods")](ga("e`u`@ohl`uhnoHuds`uhnoDoe"), function () { W._fTWm && W._fTWm(m); }); }
    function Ua(m, s, q) {
        q = q || "normal";
    ...
    function F(m, s) {
        var q = [];
        if (q = { solid: [], shortDash: [3, 1], shortDot: [1, 1], shortDashDot: [3, 1, 1, 1], shortDashDotDot: [3, 1, 1, 1, 1, 1], dot: [1, 2], dash: [4, 2], dashDot: [4, 2, 1,
    ...
    function P(m, s, q, v, y) { v = v || []; y = y || !1; v.push([m, s, q, y]); return m.addEventListener ? (m.addEventListener(s, q, y), q) : m.attachEvent ? (v = function (s) { s = s || window.event; s.preventDefault = s.preventDefault || function () { s.returnValue = !1; }; s.stopPropagation = s.stopPropagation || function () { s.cancelBubble = !0; }; q.call(m, s); }, m.attachEvent("on" + s, v), v) : !1; }
    function Wa(m, s, q) {
        m *= ia;
        s *= ia;
        m =
    ...
    function ja(m, s, q) { return m in s ? s[m] : q[m]; }
    function Ga(m, s, q) {
        if (v && Xa) {
    ...
    function ta(m, s) { var q = document.createElement("canvas"); q.setAttribute("class", "canvasjs-chart-canvas"); Ga(q, m, s); v || "undefined" === typeof G_vmlCanvasManager || G_vmlCanvasManager.initElement(q); return q; }
    function oa(m, s, q) { for (var v in q)
        s.style[v] = q[v]; }
    function ua(m, s, q) {
        s.getAttribute("state") || (s.style.backgroundColor = m.toolbar.backgroundColor, s.style.color = m.toolbar.fontColor, s.style.border = "none", oa(m, s, { WebkitUserSelect: "none",
    ...
    function va() { for (var m = null, s = 0; s < arguments.length; s++)
    ...
    function Da(m, s, q, v, y) { "undefined" === typeof y && (y = 0); this._padding = y; this._x1 = m; this._y1 = s; this._x2 = q; this._y2 = v; this._rightOccupied = this._leftOccupied = this._bottomOccupied = this._topOccupied = this._padding; }
    function ka(m, s) { ka.base.constructor.call(this, "TextBlock", null, s, null, null); this.ctx = m; this._isDirty = !0; this._wrappedText = null; this._initialize(); }
    function Ra(m, s) {
    ...
    function Ia(m) { var s; m && Ja[m] && (s = Ja[m]); Ia.base.constructor.call(this, "CultureInfo", null, s, null, null); }
    var W = {}, v = !!document.createElement("canvas").getContext, qa = { Chart: { width: 500, height: 400, zoomEnabled: !1, zoomType: "x", backgroundColor: "white", theme: "light1", animationEnabled: !1, animationDuration: 1200, dataPointWidth: null, dataPointMinWidth: null,
    ...
    var ba = 20, z = 14, Sa = { colorSet: "colorSet1", backgroundColor: "#FFFFFF", title: { fontFamily: Ea, fontSize: 32, fontColor: fa, fontWeight: "normal", verticalAlign: "top", margin: 5 }, subtitles: [{ fontFamily: Ea, fontSize: z, fontColor: fa, fontWeight: "normal", verticalAlign: "top", margin: 5 }], data: [{ indexLabelFontFamily: x, indexLabelFontSize: z, indexLabelFontColor: fa, indexLabelFontWeight: "normal", indexLabelLineThickness: 1 }], axisX: [{ titleFontFamily: x, titleFontSize: ba,
                ...
                labelFontColor: T, labelFontWeight: "normal", lineThickness: 1, lineColor: J, tickThickness: 1, tickColor: J, gridThickness: 1, gridColor: J, stripLines: [{ labelFontFamily: x, labelFontSize: z, labelFontColor: "#FF7300", labelFontWeight: "normal", labelBackgroundColor: null, color: "#FF7300", thickness: 1 }], crosshair: { labelFontFamily: x, labelFontSize: z, labelFontColor: "#EEEEEE", labelFontWeight: "normal", labelBackgroundColor: ea, color: Z, thickness: 1, lineDashType: "dash" }, scaleBreaks: { type: "zigzag", spacing: "2%", lineColor: "#BBBBBB", lineThickness: 1,
                    lineDashType: "solid" } }], legend: { fontFamily: x, fontSize: 14, fontColor: fa, fontWeight: "bold", verticalAlign: "bottom", horizontalAlign: "center" }, toolTip: { fontFamily: x, fontSize: 14, fontStyle: "normal", cornerRadius: 0, borderThickness: 1 } };
    T = fa = "#F5F5F5";
    J = "#FFFFFF";
    Z = "#40BAF1";
    ea = "#F5F5F5";
    var ba = 20, z = 14, Ya = { colorSet: "colorSet2", title: { fontFamily: x, fontSize: 33, fontColor: "#3A3A3A", fontWeight: "bold", verticalAlign: "top", margin: 5 }, subtitles: [{ fontFamily: x, fontSize: z, fontColor: "#3A3A3A", fontWeight: "normal", verticalAlign: "top",
            ...
            verticalAlign: "bottom", horizontalAlign: "center" }, toolTip: { fontFamily: x, fontSize: 14, fontStyle: "normal", cornerRadius: 0, borderThickness: 1 } };
    T = fa = "#F5F5F5";
    J = "#FFFFFF";
    Z = "#40BAF1";
    ea = "#F5F5F5";
    ba = 20;
    z = 14;
    Ea = { colorSet: "colorSet12", backgroundColor: "#2A2A2A", title: { fontFamily: Ea, fontSize: 32, fontColor: fa, fontWeight: "normal", verticalAlign: "top", margin: 5 }, subtitles: [{ fontFamily: Ea, fontSize: z, fontColor: fa, fontWeight: "normal", verticalAlign: "top", margin: 5 }], toolbar: { backgroundColor: "#666666", backgroundColorOnHover: "#FF7372",
    ...
    (function () {
        W.fSDec = function (m) {
            for (var s = "", q = 0; q < m.length; q++)
                s += String.fromCharCode(Math.ceil(m.length /
                    57 / 5) ^ m.charCodeAt(q));
            return s;
        };
        W.obj = { trVs: "Ush`m!Wdsrhno", fntStr: "qy!B`mhcsh-!Mtbhe`!Fs`oed-!Mtbhe`!R`or!Tohbned-!@sh`m-!r`or,rdshg", txtBl: "udyuC`rdmhod", fnt: "gnou", fSy: "ghmmRuxmd", fTx: "ghmmUdyu", grClr: "fsdx", cntx: "buy", tp: "unq" };
    ...
    var Va = {}, pa = null, Aa = function () {
        ...
        return function (S, C, I) {
            ...
            I = U ? "getUTC" : "get";
            var W = S[I + "Date"](), X = S[I + "Day"](), Y = S[I + "Month"](), T = S[I + "FullYear"](), O = S[I + "Hours"](), V = S[I +
                "Minutes"](), a = S[I + "Seconds"](), f = S[I + "Milliseconds"](), b = U ? 0 : S.getTimezoneOffset();
            return I = C.replace(m, function (c) {
                switch (c) {
                    case "D": return W;
                    case "DD": return ha(W, 2);
                    case "DDD": return R[X];
                    case "DDDD": return F[X];
                    case "M": return Y + 1;
                    case "MM": return ha(Y + 1, 2);
                    case "MMM": return P[Y];
                    case "MMMM": return J[Y];
                    case "Y": return parseInt(String(T).slice(-2));
                    case "YY": return ha(String(T).slice(-2), 2);
                    case "YYY": return ha(String(T).slice(-3), 3);
                    case "YYYY": return ha(T, 4);
                    case "h": return O % 12 || 12;
                    case "hh": return ha(O %
                        12 || 12, 2);
                    case "H": return O;
                    case "HH": return ha(O, 2);
                    case "m": return V;
                    case "mm": return ha(V, 2);
                    case "s": return a;
                    ...
                    case "t": return 12 > O ? "a" : "p";
                    case "tt": return 12 > O ? "am" : "pm";
                    case "T": return 12 > O ? "A" : "P";
                    case "TT": return 12 > O ? "AM" : "PM";
                    case "K": return U ? "UTC" : (String(S).match(x) || [""]).pop().replace(z, "");
                    case "z": return (0 < b ? "-" : "+") + Math.floor(Math.abs(b) /
                        60);
        ...
        s = String(s);
        var z = 1, S = q = "", C = -1, I = [], F = [], J = 0, R = 0, U = 0, P = !1, W = 0, S = s.match(/"[^"]*"|'[^']*'|[eE][+-]*[0]+|[,]+[.]|\u2030|./g);
        s = null;
        for (var X = 0; S && X < S.length; X++)
            if (s = S[X], "." === s && 0 > C)
                ...
                if ("%" === s)
                    ...
                    "E" !== s[0] && "e" !== s[0] || "0" !== s[s.length - 1] || (P = !0);
        ...
        for (P = S = X = R = C = 0; 0 < I.length;)
            if (s = I.pop(), "#" === s || "0" === s)
                if (C++, C === J) {
                    var Y = z, z = [];
                    if ("0" === s)
                        for (s = J - R - (Y ? Y.length : 0); 0 < s;)
                            Y.unshift("0"), s--;
                    for (; 0 < Y.length;)
                        q = Y.pop() + q, P++, 0 === P % S && (X === U && 0 < Y.length) && (q = x + q);
                }
                else
                    0 < z.length ? (q = z.pop() + q, R++, P++) : "0" === s && (q = "0" + q, R++, P++), 0 === P % S && (X === U && 0 < z.length) && (q = x + q);
            else
                "E" !== s[0] && "e" !== s[0] || "0" !== s[s.length - 1] || !/[eE][+-]*[0]+/.test(s) ? "," === s ? (X++, S = P, P = 0, 0 < z.length && (q = x + q)) :
                    q = 1 < s.length && ('"' === s[0] && '"' === s[s.length - 1] || "'" === s[0] && "'" === s[s.length - 1]) ? s.slice(1, s.length - 1) + q : s + q : (s = 0 > W ? s.replace("+", "").replace("-", "") : s.replace("-", ""), q += s.replace(/[0]+/, function (m) { return ha(W, m.length); }));
        x = "";
        for (I = !1; 0 < F.length;)
            s = F.shift(), "#" === s || "0" === s ? 0 < m.length && 0 !== Number(m.join("")) ? (x += m.shift(), I = !0) : "0" === s && (x += "0", I = !0) : 1 < s.length && ('"' === s[0] && '"' === s[s.length - 1] || "'" === s[0] && "'" === s[s.length - 1]) ? x += s.slice(1, s.length - 1) : "E" !== s[0] && "e" !== s[0] || "0" !== s[s.length -
                1] || !/[eE][+-]*[0]+/.test(s) ? x += s : (s = 0 > W ? s.replace("+", "").replace("-", "") : s.replace("-", ""), x += s.replace(/[0]+/, function (m) { return ha(W, m.length); }));
        q += (I ? y : "") + x;
        return v ? "-" + q : q;
    ...
    Y.prototype.setOptions = function (m, s) { if (qa[this._defaultsKey]) {
        var q = qa[this._defaultsKey], v;
        for (v in q)
            "publicProperties" !== v && q.hasOwnProperty(v) && (this[v] = m && v in m ? m[v] : s && v in s ? s[v] : q[v]);
    } };
    Y.prototype.get = function (m) { var s = qa[this._defaultsKey]; if ("options" === m)
        return this.options && this.options._isPlaceholder ? null : this.options; if (s.hasOwnProperty(m) || s.publicProperties && s.publicProperties.hasOwnProperty(m))
    ...
    Y.prototype.createUserOptions = function (m) {
        if ("undefined" !== typeof m || this.options._isPlaceholder)
            if (this.parent.options._isPlaceholder && this.parent.createUserOptions(), this.isOptionsInArray) {
                ...
                this.options = "undefined" === typeof m ? {} : m, m = this.parent.options, this.optionsName ? s = this.optionsName : (s = this._defaultsKey) && 0 !== s.length ? (v = s.charAt(0).toLowerCase(), 1 < s.length && (v = v.concat(s.slice(1))), s = v) : s = void 0, m[s] = this.options;
    };
    ...
    Y.prototype.addEventListener = function (m, s, v) { m && s && (this._eventListeners[m] = this._eventListeners[m] || [], this._eventListeners[m].push({ context: v || this, eventHandler: s })); };
    Y.prototype.removeEventListener = function (m, v) { if (m && v && this._eventListeners[m])
    ...
    Y.prototype.dispatchEvent = function (m, v, q) { if (m && this._eventListeners[m]) {
        v = v || {};
    ...
    Da.prototype.registerSpace = function (m, v) { "top" === m ? this._topOccupied += v.height : "bottom" === m ? this._bottomOccupied += v.height : "left" === m ? this._leftOccupied += v.width : "right" === m && (this._rightOccupied += v.width); };
    Da.prototype.unRegisterSpace =
        function (m, v) { "top" === m ? this._topOccupied -= v.height : "bottom" === m ? this._bottomOccupied -= v.height : "left" === m ? this._leftOccupied -= v.width : "right" === m && (this._rightOccupied -= v.width); };
    Da.prototype.getFreeSpace = function () { return { x1: this._x1 + this._leftOccupied, y1: this._y1 + this._topOccupied, x2: this._x2 - this._rightOccupied, y2: this._y2 - this._bottomOccupied, width: this._x2 - this._x1 - this._rightOccupied - this._leftOccupied, height: this._y2 - this._y1 - this._bottomOccupied - this._topOccupied }; };
    ...
    ka.prototype.render = function (m) {
        if (0 !== this.fontSize) {
            ...
            for (q = 0; q < this._wrappedText.lines.length; q++)
                z = this._wrappedText.lines[q], "right" === this.horizontalAlign ? y = (this.width - (this.leftPadding + this.rightPadding)) / 2 - z.width / 2 + this.leftPadding : "left" === this.horizontalAlign ? y = this.leftPadding : "center" === this.horizontalAlign && (y = (this.width - (this.leftPadding + this.rightPadding)) / 2 - z.width / 2 + this.leftPadding),
    ...
    ka.prototype.measureText = function () { this._lineHeight = Ua(this.fontFamily, this.fontSize, this.fontWeight); if (null === this.maxWidth)
    ...
    ka.prototype._getLineWithWidth = function (m, v, q) {
        ...
        v = !0;
        if (F.length === m.length || " " === m[F.length])
            v = !1;
        v && (m = F.split(" "), 1 < m.length && m.pop(), F = m.join(" "), q = this.ctx.measureText(F).width);
        return { text: F, width: q };
    };
    ka.prototype._wrapText = function () {
        var m = new String(Fa(String(this.text))), v = [], q = this.ctx.font, y = 0, x = 0;
        this.ctx.font = this._getFontString();
        if (0 === this.frontSize)
            x = y = 0;
        else
            for (; 0 < m.length;) {
                var z = this.maxHeight - (this.topPadding + this.bottomPadding), F = this._getLineWithWidth(m, this.maxWidth - (this.leftPadding + this.rightPadding), !1);
    ...
    ka.prototype._getFontString = function () { var m; m = "" + (this.fontStyle ? this.fontStyle + " " : ""); m += this.fontWeight ? this.fontWeight + " " : ""; m += this.fontSize ? this.fontSize + "px " : ""; var s = this.fontFamily ? this.fontFamily + "" : ""; !v && s && (s = s.split(",")[0], "'" !== s[0] && '"' !== s[0] && (s = "'" + s + "'")); return m += s; };
    na(Ra, Y);
    na(Ha, Y);
    Ha.prototype.render = function () {
        if (this.text) {
            var m = this.dockInsidePlotArea ? this.chart.plotArea : this.chart, v = m.layoutManager.getFreeSpace(), q = v.x1, x = v.y1, z = 0, F = 0, R = this.chart._menuButton && this.chart.exportEnabled && "top" === this.verticalAlign ? 22 : 0, S, C;
            ...
            F = new ka(this.ctx, { fontSize: this.fontSize, fontFamily: this.fontFamily, fontColor: this.fontColor,
    ...
    na(Ia, Y);
    var Ka = { addTheme: function (m, v) { xa[m] = v; }, addColorSet: function (m, v) { za[m] = v; }, addCultureInfo: function (m, v) { Ja[m] = v; }, formatNumber: function (m, v, q) { q = q || "en"; if (Ja[q])
            return V(m, v || "#,##0.##", new Ia(q)); throw "Unknown Culture Name"; }, formatDate: function (m, v, q) { q = q || "en"; if (Ja[q])
            return Aa(m, v || "DD MMM YYYY", new Ia(q)); throw "Unknown Culture Name"; } };
    "undefined" !== typeof module && "undefined" !== typeof module.exports ? module.exports = Ka : "function" === typeof define &&
        define.amd ? define([], function () { return Ka; }) : window.CanvasJS = Ka;
    Ka.Chart = function () {
        ...
        function q(a, f) {
            ...
            this.plotArea = { canvas: null, ctx: null, x1: 0, y1: 0, x2: 0, y2: 0,
                width: 0, height: 0 };
        ...
        function x(a, f) {
            for (var b = [], c, e = 0; e < a.length; e++)
                if (0 == e)
                    ...
                    var t = (a[h].x - a[g].x) / c;
                    c = (a[h].y - a[g].y) / c;
                    b[b.length] = a[l].x > a[g].x && 0 < t || a[l].x < a[g].x && 0 > t ? { x: a[l].x + t / 3,
                        y: a[l].y + c / 3 } : { x: a[l].x, y: a[l].y + c / 9 };
                    l = e;
                    g = 0 === l ? 0 : l - 1;
                    h = l === a.length - 1 ? l : l + 1;
        ...
        function I(a, f, b, c) {
            ...
            if (this.options.customBreaks && 0 < this.options.customBreaks.length) {
                for (a = 0; a < this.options.customBreaks.length; a++)
                    this.customBreaks.push(new ba(this.chart, "customBreaks", this.options.customBreaks[a], a, ++this.chart._eventManager.lastObjectId, this)), "number" === typeof this.customBreaks[a].startValue && ("number" === typeof this.customBreaks[a].endValue &&
                ...
                for (a = 0; a < this._appliedBreaks.length - 1; a++)
                    this._appliedBreaks[a].endValue >= this._appliedBreaks[a + 1].startValue && (this._appliedBreaks[a].endValue = Math.max(this._appliedBreaks[a].endValue, this._appliedBreaks[a + 1].endValue), window.console && window.console.log("CanvasJS Error: Breaks " + a + " and " + (a + 1) + " are overlapping."),
        ...
        function ga(a) { this.chart = a; this.ctx = this.chart.plotArea.ctx; this.animations = []; this.animationRequestId = null; }
        na(q, Y);
        ...
        q.prototype._updateOptions = function () {
            ...
            if (this.options.zoomEnabled) {
                if (!this._zoomButton) {
                    ...
                    P(this._zoomButton, "touchstart", function (a) { f = !0; }, this.allDOMEventHandlers);
                    ...
                    P(this._zoomButton, "mouseover", function () { f ? f = !1 : (oa(a, a._zoomButton, { backgroundColor: a.toolbar.backgroundColorOnHover, color: a.toolbar.fontColorOnHover, transition: "0.4s", WebkitTransition: "0.4s" }), 0 >= navigator.userAgent.search("MSIE") && oa(a, a._zoomButton.childNodes[0], { WebkitFilter: "invert(100%)", filter: "invert(100%)" })); }, this.allDOMEventHandlers);
                ...
                this._resetButton || (f = !1, va(this._resetButton = document.createElement("button")), ua(this, this._resetButton, "reset"), this._resetButton.style.borderRight = (this.exportEnabled ? this.toolbar.borderThickness : 0) + "px solid " + this.toolbar.borderColor,
                    ...
                    if (a.sessionVariables.axisX)
                        for (var c = 0; c < a.sessionVariables.axisX.length; c++)
                            a.sessionVariables.axisX[c].newViewportMinimum =
                    ...
                    if (a.sessionVariables.axisY2)
                        for (c = 0; c < a.sessionVariables.axisY2.length; c++)
                            a.sessionVariables.axisY2[c].newViewportMinimum =
                    ...
                    f || (oa(a, a._resetButton, { backgroundColor: a.toolbar.backgroundColorOnHover, color: a.toolbar.hoverFfontColorOnHoverontColor, transition: "0.4s", WebkitTransition: "0.4s" }), 0 >= navigator.userAgent.search("MSIE") && oa(a, a._resetButton.childNodes[0], { WebkitFilter: "invert(100%)", filter: "invert(100%)" }));
            ...
            this._menuButton ? this.exportEnabled ? Ma(this._menuButton) : va(this._menuButton) : this.exportEnabled && v && (f = !1, this._menuButton = document.createElement("button"), ua(this, this._menuButton, "menu"), this._toolBar.appendChild(this._menuButton), P(this._menuButton, "touchstart", function (a) { f = !0; }, this.allDOMEventHandlers), P(this._menuButton, "click", function () { "none" !== a._dropdownMenu.style.display || a._dropDownCloseTime && 500 >= (new Date).getTime() - a._dropDownCloseTime.getTime() || (a._dropdownMenu.style.display = "block", a._menuButton.blur(), a._dropdownMenu.focus()); }, this.allDOMEventHandlers, !0), P(this._menuButton, "mouseover", function () {
            ...
            }, this.allDOMEventHandlers, !0), P(this._menuButton, "mouseout", function () { f || (oa(a, a._menuButton, { backgroundColor: a.toolbar.backgroundColor, color: a.toolbar.fontColor }), 0 >= navigator.userAgent.search("MSIE") && oa(a, a._menuButton.childNodes[0], { WebkitFilter: "invert(0%)", filter: "invert(0%)" })); }, this.allDOMEventHandlers, !0));
            if (!this._dropdownMenu && this.exportEnabled && v) {
                ...
                P(this._dropdownMenu, "blur", function () { va(a._dropdownMenu); a._dropDownCloseTime = new Date; }, this.allDOMEventHandlers, !0);
                ...
                P(b, "touchstart", function (a) { f = !0; }, this.allDOMEventHandlers);
                P(b, "mouseover", function () { f || (this.style.backgroundColor = a.toolbar.backgroundColorOnHover, this.style.color = a.toolbar.fontColorOnHover); }, this.allDOMEventHandlers, !0);
                P(b, "mouseout", function () { f || (this.style.backgroundColor = a.toolbar.backgroundColor, this.style.color = a.toolbar.fontColor); }, this.allDOMEventHandlers, !0);
                P(b, "click", function () { a.print(); va(a._dropdownMenu); }, this.allDOMEventHandlers, !0);
                b = document.createElement("div");
                b.style.cssText = "padding: 12px 8px 12px 8px";
                ...
                P(b, "mouseover", function () { f || (this.style.backgroundColor = a.toolbar.backgroundColorOnHover, this.style.color = a.toolbar.fontColorOnHover); }, this.allDOMEventHandlers, !0);
                P(b, "mouseout", function () { f || (this.style.backgroundColor = a.toolbar.backgroundColor, this.style.color = a.toolbar.fontColor); }, this.allDOMEventHandlers, !0);
                P(b, "click", function () { s(a.canvas, "jpeg", a.exportFileName); va(a._dropdownMenu); }, this.allDOMEventHandlers, !0);
                b = document.createElement("div");
                b.style.cssText = "padding: 12px 8px 12px 8px";
                ...
                P(b, "mouseout", function () { f || (this.style.backgroundColor = a.toolbar.backgroundColor, this.style.color = a.toolbar.fontColor); }, this.allDOMEventHandlers, !0);
                P(b, "click", function () { s(a.canvas, "png", a.exportFileName); va(a._dropdownMenu); }, this.allDOMEventHandlers, !0);
            }
        ...
        q.prototype._updateSize = function () {
            ...
            this.options.height ? f = this.height : this.height = f = 0 < this.container.clientHeight ? this.container.clientHeight :
                this.height;
            return this.canvas.width !== a * ia || this.canvas.height !== f * ia ? (Ga(this.canvas, a, f), Ga(this._preRenderCanvas, a, f), Ga(this.overlaidCanvas, a, f), Ga(this._eventManager.ghostCanvas, a, f), this.bounds = { x1: 0, y1: 0, x2: this.width, y2: this.height }, !0) : !1;
        };
        ...
        q.prototype.render = function (a) {
            ...
            bb(this);
            this._processData();
            this.options.title && (this.title = new Ha(this, this.options.title), this.title.dockInsidePlotArea ? f.push(this.title) : this.title.render());
        ...
        q.prototype.assignIdToDataPoints = function () { for (var a = 0; a < this.data.length; a++) {
            var f = this.data[a];
            if (f.dataPoints)
        ...
        q.prototype.getObjectAtXY = function (a, f, b) {
            ...
            if (b = this.getDataPointAtXY(a, f, b || !1))
                ...
                c = Wa(a, f, this._eventManager.ghostCtx);
            else
        ...
        q.prototype.getAutoFontSize = function (a, f, b) { f = Math.min(this.width, this.height); return Math.max("theme4" === this.theme ? 0 : 300 <= f ? 12 : 10, Math.round(f * (a / 400))); };
        q.prototype.resetOverlayedCanvas = function () { this.overlaidCanvasCtx.clearRect(0, 0, this.width, this.height); };
        q.prototype.clearCanvas = function () { this.ctx.clearRect(0, 0, this.width, this.height); this.backgroundColor && (this.ctx.fillStyle = this.backgroundColor, this.ctx.fillRect(0, 0, this.width, this.height)); };
        q.prototype.attachEvent = function (a) { this._events.push(a); };
        ...
        q.prototype._plotAreaMouseDown = function (a, f) { this.isDrag = !0; this.dragStartPoint = { x: a, y: f }; };
        q.prototype._plotAreaMouseUp = function (a, f) {
            if (("normal" === this.plotInfo.axisPlacement || "xySwapped" === this.plotInfo.axisPlacement) && this.isDrag) {
                ...
                if (this.panEnabled || this.zoomEnabled) {
                    ...
                    h && (this._ignoreNextEvent = !0, this._dispatchRangeEvent("rangeChanging", "zoom"), this.render(), this._dispatchRangeEvent("rangeChanged", "zoom"), h && (this.zoomEnabled && "none" === this._zoomButton.style.display) && (Ma(this._zoomButton, this._resetButton), ua(this, this._zoomButton, "pan"), ua(this, this._resetButton, "reset")));
                }
            }
            this.isDrag = !1;
        ...
        q.prototype._zoomPanToSelectedRegion = function (a, f, b, c, e) { a = this.validateRegion(a, f, b, c, e); f = a.axesWithValidRange; b = a.axesRanges; if (a.isValid)
        ...
        q.prototype.renderIndexLabels = function (a) {
            ...
            for (a = 0; a < this._indexLabels.length; a++) {
                var k = this._indexLabels[a], r = k.chartType.toLowerCase(), p, n, l = ja("indexLabelFontColor", k.dataPoint, k.dataSeries), t = ja("indexLabelFontSize", k.dataPoint, k.dataSeries);
                p = ja("indexLabelFontFamily", k.dataPoint, k.dataSeries);
                n = ja("indexLabelFontStyle", k.dataPoint, k.dataSeries);
                var h = ja("indexLabelFontWeight", k.dataPoint, k.dataSeries), d = ja("indexLabelBackgroundColor", k.dataPoint, k.dataSeries), e = ja("indexLabelMaxWidth", k.dataPoint, k.dataSeries), g = ja("indexLabelWrap", k.dataPoint, k.dataSeries), w = ja("indexLabelLineDashType", k.dataPoint, k.dataSeries), m = ja("indexLabelLineColor", k.dataPoint, k.dataSeries), D = y(k.dataPoint.indexLabelLineThickness) ? y(k.dataSeries.options.indexLabelLineThickness) ? 0 : k.dataSeries.options.indexLabelLineThickness : k.dataPoint.indexLabelLineThickness, c = 0 < D ? Math.min(10, ("normal" === this.plotInfo.axisPlacement ? this.plotArea.height : this.plotArea.width) << 0) : 0, u = { percent: null, total: null }, Q = null;
                ...
                if (k.dataSeries.indexLabelFormatter || k.dataPoint.indexLabelFormatter)
                    Q = { chart: this, dataSeries: k.dataSeries, dataPoint: k.dataPoint, index: k.indexKeyword, total: u.total, percent: u.percent };
                ...
                if (null !== H && "" !== H) {
                    var u = ja("indexLabelPlacement", k.dataPoint, k.dataSeries), Q = ja("indexLabelOrientation", k.dataPoint, k.dataSeries), q = k.direction, s = k.dataSeries.axisX, A = k.dataSeries.axisY, x = !1, d = new ka(f, { x: 0, y: 0, maxWidth: e ? e : 0.5 * this.width, maxHeight: g ? 5 * t : 1.5 * t, angle: "horizontal" === Q ? 0 : -90, text: H, padding: 0, backgroundColor: d, horizontalAlign: "left",
            ...
            f = { source: f, dest: this.plotArea.ctx, animationCallback: O.fadeInAnimation, easingFunction: O.easing.easeInQuad, animationBase: 0, startTimePercent: 0.7 };
            for (a = 0; a < this._indexLabels.length; a++)
                k = this._indexLabels[a], d = ja("indexLabelBackgroundColor", k.dataPoint, k.dataSeries), k.dataSeries.indexLabelBackgroundColor = y(d) ? v ? "transparent" : null : d;
            return f;
        };
            ...
            function (a) {
                ...
                if (!(0 >= a.dataSeriesIndexes.length)) {
                    ...
                    for (var g = [], h, l = 0; l < a.dataSeriesIndexes.length; l++) {
                        ...
                        if (b.setLineDash) {
                            var n = F(k.nullDataLineDashType, k.lineThickness), p = k.lineDashType, d = F(p, k.lineThickness);
                            b.setLineDash(d);
                        }
                        var w = k.id;
                            ...
                            for (var q = !1, u = 0; u < r.length; u++)
                                if (Q = r[u].x.getTime ? r[u].x.getTime() : r[u].x, !(Q < a.axisX.dataInfo.viewPortMin || Q > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !q)))
                                    if ("number" !== typeof r[u].y)
                                        ...
                                        this._eventManager.objectMap[s] = { id: s, objectType: "dataPoint", dataSeriesIndex: t, dataPointIndex: u, x1: Q, y1: H };
                                        D || q ? (!D && k.connectNullData ? (b.setLineDash && (k.options.nullDataLineDashType || p === k.lineDashType && k.lineDashType !== k.nullDataLineDashType) && (b.stroke(), b.beginPath(), b.moveTo(h.x, h.y), p = k.nullDataLineDashType, b.setLineDash(n)), b.lineTo(Q, H), v && c.lineTo(Q, H)) : (b.beginPath(), b.moveTo(Q, H), v && (c.beginPath(), c.moveTo(Q, H))), q = D = !1) : (b.lineTo(Q, H), v && c.lineTo(Q, H), 0 == u % 500 && (b.stroke(), b.beginPath(), b.moveTo(Q, H), v && (c.stroke(), c.beginPath(), c.moveTo(Q, H))));
                                        h = { x: Q, y: H };
                                        ...
                                        if (0 < r[u].markerSize || 0 < k.markerSize) {
                                            ...
                                            g.push(A);
                                            s = R(s);
                                            v && g.push({ x: Q, y: H, ctx: c, type: A.type, size: A.size, color: s, borderColor: s, borderThickness: A.borderThickness });
                                        }
                                        (r[u].indexLabel || k.indexLabel || r[u].indexLabelFormatter || k.indexLabelFormatter) && this._indexLabels.push({ chartType: "line", dataPoint: r[u], dataSeries: k, point: { x: Q, y: H }, direction: 0 > r[u].y === a.axisY.reversed ? 1 : -1, color: w });
                                    }
                            b.stroke();
                            v && c.stroke();
                        }
                    ...
                    b.restore();
                    b.beginPath();
                    return { source: f, dest: this.plotArea.ctx, animationCallback: O.xClipAnimation, easingFunction: O.easing.linear,
                        animationBase: 0 };
                }
            };
        q.prototype.renderStepLine = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                        ...
                        for (var q = !1, u = 0; u < r.length; u++)
                            if (Q = r[u].getTime ? r[u].x.getTime() : r[u].x, !(Q < a.axisX.dataInfo.viewPortMin || Q > a.axisX.dataInfo.viewPortMax &&
                                ...
                                if ("number" !== typeof r[u].y)
                                    ...
                                    this._eventManager.objectMap[A] = { id: A, objectType: "dataPoint", dataSeriesIndex: t, dataPointIndex: u, x1: Q, y1: H };
                                    D || q ? (!D && k.connectNullData ? (b.setLineDash && (k.options.nullDataLineDashType || p === k.lineDashType && k.lineDashType !== k.nullDataLineDashType) && (b.stroke(), b.beginPath(), b.moveTo(h.x, h.y), p = k.nullDataLineDashType, b.setLineDash(n)), b.lineTo(Q, s), b.lineTo(Q, H), v && (c.lineTo(Q, s), c.lineTo(Q, H))) : (b.beginPath(), b.moveTo(Q, H), v && (c.beginPath(), c.moveTo(Q, H))), q = D = !1) : (b.lineTo(Q, s), v && c.lineTo(Q, s), b.lineTo(Q, H), v && c.lineTo(Q, H), 0 == u % 500 && (b.stroke(), b.beginPath(), b.moveTo(Q, H), v && (c.stroke(), c.beginPath(), c.moveTo(Q, H))));
                                    h = { x: Q, y: H };
                                    ...
                                    if (0 < r[u].markerSize || 0 < k.markerSize)
                                        s = k.getMarkerProperties(u, Q, H, b), g.push(s), A = R(A), v && g.push({ x: Q, y: H, ctx: c, type: s.type, size: s.size, color: A, borderColor: A, borderThickness: s.borderThickness });
                                    (r[u].indexLabel || k.indexLabel || r[u].indexLabelFormatter || k.indexLabelFormatter) && this._indexLabels.push({ chartType: "stepLine", dataPoint: r[u], dataSeries: k, point: { x: Q, y: H }, direction: 0 >
                ...
                b.restore();
                b.beginPath();
                return { source: f, dest: this.plotArea.ctx, animationCallback: O.xClipAnimation, easingFunction: O.easing.linear, animationBase: 0 };
            }
        };
        q.prototype.renderSpline = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                        ...
                        for (Q = !1, D = 0; D < r.length; D++)
                            if (u = r[D].getTime ? r[D].x.getTime() : r[D].x, !(u < a.axisX.dataInfo.viewPortMin || u > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !Q)))
                                if ("number" !== typeof r[D].y)
                                    0 < D && !Q && (k.connectNullData ? c.setLineDash && (0 < H.length && (k.options.nullDataLineDashType || !r[D - 1].lineDashType)) && (H[H.length -
                                    ...
                                    this._eventManager.objectMap[s] = { id: s, objectType: "dataPoint", dataSeriesIndex: t, dataPointIndex: D, x1: u, y1: Q };
                                    H[H.length] = { x: u, y: Q };
                                    ...
                                    if (0 < r[D].markerSize || 0 < k.markerSize) {
                                        ...
                                        h.push(q);
                                        s = R(s);
                                        v && h.push({ x: u, y: Q, ctx: e, type: q.type, size: q.size, color: s, borderColor: s, borderThickness: q.borderThickness });
                                    }
                                    (r[D].indexLabel || k.indexLabel || r[D].indexLabelFormatter || k.indexLabelFormatter) && this._indexLabels.push({ chartType: "spline", dataPoint: r[D], dataSeries: k, point: { x: u, y: Q }, direction: 0 > r[D].y === a.axisY.reversed ? 1 : -1, color: w });
                                    Q = !1;
                                }
                    f(H);
                }
                ...
                c.restore();
                c.beginPath();
                return { source: b, dest: this.plotArea.ctx, animationCallback: O.xClipAnimation,
        ...
        q.prototype.renderColumn = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var c = null, e = this.plotArea, g = 0, h, l, t, k = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), g = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1, r = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : Math.min(0.15 *
                    this.width, 0.9 * (this.plotArea.width / a.plotType.totalDataSeries)) << 0, p = a.axisX.dataInfo.minDiff;
                    ...
                    if (0 < w.length)
                        for (var m = 5 < p && d.bevelEnabled ? !0 : !1, g = 0; g <
                            ...
                            if (w[g].getTime ? t = w[g].x.getTime() : t = w[g].x, !(t < a.axisX.dataInfo.viewPortMin || t > a.axisX.dataInfo.viewPortMax) && "number" === typeof w[g].y) {
                                ...
                                (w[g].indexLabel || d.indexLabel || w[g].indexLabelFormatter || d.indexLabelFormatter) && this._indexLabels.push({ chartType: "column", dataPoint: w[g], dataSeries: d, point: { x: h + (D - h) / 2, y: 0 > w[g].y === a.axisY.reversed ? l : u }, direction: 0 > w[g].y ===
                                        a.axisY.reversed ? 1 : -1, bounds: { x1: h, y1: Math.min(l, u), x2: D, y2: Math.max(l, u) }, color: c });
                            }
                }
                v && (f.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && b.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && b.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.clearRect(e.x1, e.y1, e.width, e.height), this._eventManager.ghostCtx.restore());
                b.restore();
                return { source: f, dest: this.plotArea.ctx, animationCallback: O.yScaleAnimation, easingFunction: O.easing.easeOutQuart, animationBase: k < a.axisY.bounds.y1 ? a.axisY.bounds.y1 : k > a.axisY.bounds.y2 ? a.axisY.bounds.y2 : k };
            }
        };
        q.prototype.renderStackedColumn = function (a) {
            var f = a.targetCanvasCtx || this.plotArea.ctx, b = v ? this._preRenderCtx : f;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var c = null, e = this.plotArea, g = [], h = [], l = [], t = [], k = 0, r, p, n = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), k = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1;
                        ...
                        for (k = 0; k < u.length; k++)
                            if (c = u[k].x.getTime ? u[k].x.getTime() : u[k].x, !(c < a.axisX.dataInfo.viewPortMin || c > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[k].y) {
                                ...
                                if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < u[k].y)
                                    ...
                                    t[c] = u[k].y + (t[c] ? t[c] : 0), q = a.axisY.convertValueToPixel(t[c]), p = "undefined" !== typeof h[c] ? h[c] : n, h[c] = q;
                                    ...
                                    y = h[c] ? h[c] : 0, q = p + y, p = n + y, h[c] = y + (q - p);
                                c = u[k].color ? u[k].color : D._colorSet[k % D._colorSet.length];
                                X(b, H, p, s, q, c, 0, null, Q && 0 <= u[k].y, 0 > u[k].y && Q, !1, !1, D.fillOpacity);
                                c = D.dataPointIds[k];
                                this._eventManager.objectMap[c] = { id: c, objectType: "dataPoint", dataSeriesIndex: m, dataPointIndex: k, x1: H, y1: p, x2: s, y2: q };
                                c = R(c);
                                v && X(this._eventManager.ghostCtx, H, p, s, q, c, 0, null, !1, !1, !1, !1);
                                (u[k].indexLabel || D.indexLabel || u[k].indexLabelFormatter || D.indexLabelFormatter) && this._indexLabels.push({ chartType: "stackedColumn", dataPoint: u[k], dataSeries: D, point: { x: r, y: 0 <= u[k].y ? p : q }, direction: 0 > u[k].y === a.axisY.reversed ? 1 :
                ...
                v && (f.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && b.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && b.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.clearRect(e.x1, e.y1, e.width, e.height), this._eventManager.ghostCtx.restore());
                b.restore();
                return { source: f, dest: this.plotArea.ctx, animationCallback: O.yScaleAnimation, easingFunction: O.easing.easeOutQuart, animationBase: n < a.axisY.bounds.y1 ? a.axisY.bounds.y1 : n > a.axisY.bounds.y2 ? a.axisY.bounds.y2 : n };
            }
        };
                        ...
                        for (var Q = 5 < d && D.bevelEnabled ? !0 : !1, k = 0; k < u.length; k++)
                            if (c = u[k].x.getTime ? u[k].x.getTime() : u[k].x, !(c < a.axisX.dataInfo.viewPortMin || c > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[k].y) {
                                ...
                                if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length &&
                                    ...
                                    t[c] = p + ("undefined" !== typeof t[c] ? t[c] : 0), y = a.axisY.convertValueToPixel(t[c]), p = h[c] ? h[c] : n, h[c] = y;
                                ...
                                c = D.dataPointIds[k];
                                this._eventManager.objectMap[c] = { id: c, objectType: "dataPoint", dataSeriesIndex: m, dataPointIndex: k, x1: q, y1: p, x2: s, y2: y };
                                c = R(c);
        ...
        q.prototype.renderBar = function (a) {
            var f = a.targetCanvasCtx || this.plotArea.ctx, b = v ? this._preRenderCtx : f;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var c = null, e = this.plotArea, g = 0, h, l, t, k = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), g = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1, r = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : Math.min(0.15 * this.height, 0.9 * (this.plotArea.height / a.plotType.totalDataSeries)) << 0, p = a.axisX.dataInfo.minDiff;
                isFinite(p) || (p = 0.3 * Math.abs(a.axisX.range));
                    ...
                    if (0 < w.length) {
                        ...
                        for (g = 0; g < w.length; g++)
                            if (w[g].getTime ? t = w[g].x.getTime() : t = w[g].x, !(t < a.axisX.dataInfo.viewPortMin || t > a.axisX.dataInfo.viewPortMax) && "number" === typeof w[g].y) {
                                ...
                                (w[g].indexLabel || d.indexLabel || w[g].indexLabelFormatter || d.indexLabelFormatter) && this._indexLabels.push({ chartType: "bar", dataPoint: w[g], dataSeries: d, point: { x: 0 <= w[g].y ? h : u, y: l + (D - l) / 2 }, direction: 0 > w[g].y === a.axisY.reversed ? 1 : -1, bounds: { x1: Math.min(u, h), y1: l, x2: Math.max(u, h), y2: D }, color: c });
                            }
                    }
                }
                v && (f.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && b.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && b.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.clearRect(e.x1, e.y1, e.width, e.height), this._eventManager.ghostCtx.restore());
                b.restore();
                return { source: f, dest: this.plotArea.ctx, animationCallback: O.xScaleAnimation, easingFunction: O.easing.easeOutQuart, animationBase: k < a.axisY.bounds.x1 ? a.axisY.bounds.x1 : k > a.axisY.bounds.x2 ? a.axisY.bounds.x2 :
                        k };
            }
        };
        q.prototype.renderStackedBar = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                    ...
                    if (0 < u.length) {
                        ...
                        for (k = 0; k < u.length; k++)
                            if (c = u[k].x.getTime ? u[k].x.getTime() :
                                ...
                                c = D.dataPointIds[k];
                                this._eventManager.objectMap[c] = { id: c, objectType: "dataPoint", dataSeriesIndex: m, dataPointIndex: k, x1: B, y1: s, x2: r, y2: y };
                                c = R(c);
                ...
                v && (f.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && b.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && b.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.clearRect(e.x1, e.y1, e.width, e.height), this._eventManager.ghostCtx.restore());
                b.restore();
                return { source: f, dest: this.plotArea.ctx, animationCallback: O.xScaleAnimation, easingFunction: O.easing.easeOutQuart, animationBase: n < a.axisY.bounds.x1 ? a.axisY.bounds.x1 : n > a.axisY.bounds.x2 ? a.axisY.bounds.x2 : n };
            }
        };
                        ...
                        for (k = 0; k < u.length; k++)
                            if (c = u[k].x.getTime ? u[k].x.getTime() : u[k].x, !(c < a.axisX.dataInfo.viewPortMin || c > a.axisX.dataInfo.viewPortMax) && "number" ===
                                ...
                                if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < u[k].y) {
                                    ...
                                    A = h[c] ? h[c] : 0, s = r - A, r = n - A, a.dataSeriesIndexes.length - 1 === w && 1 >= Math.abs(e.x1 - s) && (s = e.x1), h[c] = A + (r - s);
                                c = u[k].color ? u[k].color : D._colorSet[k % D._colorSet.length];
                                X(b, s, y, r, B, c, 0, null, q, !1, !1, !1, D.fillOpacity);
                                c = D.dataPointIds[k];
                                this._eventManager.objectMap[c] = { id: c, objectType: "dataPoint", dataSeriesIndex: m, dataPointIndex: k, x1: s, y1: y, x2: r,
                                    y2: B };
                                c = R(c);
                                v && X(this._eventManager.ghostCtx, s, y, r, B, c, 0, null, !1, !1, !1, !1);
                                (u[k].indexLabel || D.indexLabel || u[k].indexLabelFormatter || D.indexLabelFormatter) && this._indexLabels.push({ chartType: "stackedBar100", dataPoint: u[k], dataSeries: D, point: { x: 0 <= u[k].y ? r : s, y: p }, direction: 0 > u[k].y === a.axisY.reversed ? 1 : -1, bounds: { x1: Math.min(s, r), y1: y, x2: Math.max(s, r), y2: B }, color: c });
                            }
                    }
                }
                v && (f.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && b.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && b.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.clearRect(e.x1, e.y1, e.width, e.height), this._eventManager.ghostCtx.restore());
                b.restore();
                return { source: f, dest: this.plotArea.ctx, animationCallback: O.xScaleAnimation, easingFunction: O.easing.easeOutQuart, animationBase: n < a.axisY.bounds.x1 ? a.axisY.bounds.x1 : n > a.axisY.bounds.x2 ? a.axisY.bounds.x2 :
                        n };
            }
        };
        q.prototype.renderArea = function (a) {
            var f, b;
            function c() { A && (0 < w.lineThickness && g.stroke(), a.axisY.logarithmic || 0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum ? B = y : 0 > a.axisY.viewportMaximum ? B = t.y1 : 0 < a.axisY.viewportMinimum && (B = l.y2), g.lineTo(u, B), g.lineTo(A.x, B), g.closePath(), g.globalAlpha = w.fillOpacity, g.fill(), g.globalAlpha = 1, v && (h.lineTo(u, B), h.lineTo(A.x, B), h.closePath(), h.fill()), g.beginPath(), g.moveTo(u, s), h.beginPath(), h.moveTo(u, s), A = { x: u, y: s }); }
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                            ...
                            if (q = m[D].x.getTime ? m[D].x.getTime() : m[D].x, !(q <
                                ...
                                if ("number" !== typeof m[D].y)
                                    ...
                                    f || ca ? (!f && w.connectNullData ? (g.setLineDash && (w.options.nullDataLineDashType || b === w.lineDashType && w.lineDashType !== w.nullDataLineDashType) && (f = u, b = s, u = p.x, s = p.y, c(), g.moveTo(p.x, p.y), u = f, s = b, A = p, b = w.nullDataLineDashType, g.setLineDash(K)), g.lineTo(u, s), v && h.lineTo(u, s)) :
                                        (g.beginPath(), g.moveTo(u, s), v && (h.beginPath(), h.moveTo(u, s)), A = { x: u, y: s }), ca = f = !1) : (g.lineTo(u, s), v && h.lineTo(u, s), 0 == D % 250 && c());
                                    p = { x: u, y: s };
                                    ...
                                    this._eventManager.objectMap[aa] = { id: aa, objectType: "dataPoint", dataSeriesIndex: d,
                                        dataPointIndex: D, x1: u, y1: s };
                                    0 !== m[D].markerSize && (0 < m[D].markerSize || 0 < w.markerSize) && (q = w.getMarkerProperties(D, u, s, g), k.push(q), aa = R(aa), v && k.push({ x: u, y: s, ctx: h, type: q.type, size: q.size, color: aa, borderColor: aa, borderThickness: q.borderThickness }));
                ...
                g.restore();
                return { source: e, dest: this.plotArea.ctx, animationCallback: O.xClipAnimation, easingFunction: O.easing.linear,
                    animationBase: 0 };
            }
        };
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var k = 0; k < a.dataSeriesIndexes.length; k++) {
                    ...
                    if (0 < n.length) {
                        ...
                        var z = "solid";
                        if (c.setLineDash) {
                            var la = F(p.nullDataLineDashType, p.lineThickness), z = p.lineDashType, L = F(z, p.lineThickness);
                            c.setLineDash(L);
                        }
                        for (m = !1; d < n.length; d++)
                            if (w = n[d].x.getTime ? n[d].x.getTime() : n[d].x, !(w < a.axisX.dataInfo.viewPortMin || w > a.axisX.dataInfo.viewPortMax && (!p.connectNullData || !m)))
                                if ("number" !== typeof n[d].y)
                                    0 < d && !m && (p.connectNullData ? c.setLineDash && (0 < q.length && (p.options.nullDataLineDashType ||
                                    ...
                                    this._eventManager.objectMap[K] = { id: K, objectType: "dataPoint", dataSeriesIndex: r, dataPointIndex: d, x1: w, y1: m };
                                    q[q.length] = { x: w, y: m };
                                    ...
                                    if (0 !== n[d].markerSize && (0 < n[d].markerSize || 0 < p.markerSize)) {
                                        ...
                                        l.push(da);
                                        K = R(K);
                                        v && l.push({ x: w, y: m, ctx: e, type: da.type, size: da.size, color: K, borderColor: K, borderThickness: da.borderThickness });
                                    }
                                    (n[d].indexLabel || p.indexLabel || n[d].indexLabelFormatter || p.indexLabelFormatter) && this._indexLabels.push({ chartType: "splineArea", dataPoint: n[d], dataSeries: p,
                ...
                c.restore();
                return { source: b, dest: this.plotArea.ctx, animationCallback: O.xClipAnimation, easingFunction: O.easing.linear, animationBase: 0 };
            }
        };
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var n = 0; n < a.dataSeriesIndexes.length; n++) {
                    ...
                    if (0 < m.length) {
                        ...
                        var K = "solid";
                        if (g.setLineDash) {
                            var da = F(w.nullDataLineDashType, w.lineThickness), K = w.lineDashType, ca = F(K, w.lineThickness);
                            g.setLineDash(ca);
                        }
                        for (; D < m.length; D++)
        ...
        q.prototype.renderStackedArea = function (a) {
            ...
            var b = a.targetCanvasCtx || this.plotArea.ctx, c = v ? this._preRenderCtx : b;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = null, g = [], h = this.plotArea, l = [], t = [], k = [], r = [], p = 0, n, d, w, m = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), D = this._eventManager.ghostCtx, u, s, q;
                v && D.beginPath();
                c.save();
                v && D.save();
                c.beginPath();
                ...
                for (var e = [], y = 0; y < a.dataSeriesIndexes.length; y++) {
                    var B = a.dataSeriesIndexes[y], A = this.data[B], x = A.dataPoints;
                    A.dataPointIndexes = [];
                    for (p = 0; p < x.length; p++)
                        B = x[p].x.getTime ? x[p].x.getTime() : x[p].x, A.dataPointIndexes[B] = p, e[B] || (k.push(B), e[B] = !0);
                    k.sort(Pa);
                }
                            ...
                            if (!(w < a.axisX.dataInfo.viewPortMin || w > a.axisX.dataInfo.viewPortMax && (!A.connectNullData || !ca)))
                                if ("number" !== typeof aa.y)
                                    ...
                                    if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length) {
                                        ...
                                        d = a.axisY.convertValueToPixel(aa.y), d -= wa;
                                    t.push({ x: n, y: m - wa });
                                    l[w] = m - d;
                                    s || ca ? (!s && A.connectNullData ? (c.setLineDash && (A.options.nullDataLineDashType || q === A.lineDashType && A.lineDashType !== A.nullDataLineDashType) && (s = t.pop(), q = t[t.length - 1], f(), c.moveTo(u.x, u.y), t.push(q), t.push(s), q = A.nullDataLineDashType,
                                        c.setLineDash(K)), c.lineTo(n, d), v && D.lineTo(n, d)) : (c.beginPath(), c.moveTo(n, d), v && (D.beginPath(), D.moveTo(n, d))), ca = s = !1) : (c.lineTo(n, d), v && D.lineTo(n, d), 0 == p % 250 && (f(), c.moveTo(n, d), v && D.moveTo(n, d), t.push({ x: n, y: m - wa })));
                                    u = { x: n, y: d };
                                    p < x.length - 1 && (L !== (x[p].lineColor || z) || q !== (x[p].lineDashType || A.lineDashType)) && (f(), c.beginPath(), c.moveTo(n, d), t.push({ x: n, y: m - wa }), L = x[p].lineColor || z, c.strokeStyle = L, c.setLineDash && (x[p].lineDashType ? (q = x[p].lineDashType, c.setLineDash(F(q, A.lineThickness))) : (q =
                                        A.lineDashType, c.setLineDash(da))));
                                    if (0 <= A.dataPointIndexes[w]) {
                                        var ma = A.dataPointIds[A.dataPointIndexes[w]];
                                        this._eventManager.objectMap[ma] = { id: ma, objectType: "dataPoint", dataSeriesIndex: B, dataPointIndex: A.dataPointIndexes[w], x1: n, y1: d };
                                    }
                                    0 <= A.dataPointIndexes[w] && 0 !== aa.markerSize && (0 < aa.markerSize || 0 < A.markerSize) && (w = A.getMarkerProperties(A.dataPointIndexes[w], n, d, c), g.push(w), markerColor = R(ma), v && g.push({ x: n, y: d, ctx: D, type: w.type, size: w.size, color: markerColor, borderColor: markerColor, borderThickness: w.borderThickness }));
        ...
        q.prototype.renderStackedArea100 = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                            ...
                            if (!(w < a.axisX.dataInfo.viewPortMin || w > a.axisX.dataInfo.viewPortMax && (!A.connectNullData ||
                                ...
                                if ("number" !== typeof aa.y)
                                    ...
                                    if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length) {
                                        ...
                                        d = a.axisY.convertValueToPixel(wa), d -= ma;
                                    t.push({ x: n, y: q - ma });
                                    l[w] = q - d;
                                    s || ca ? (!s && A.connectNullData ? (c.setLineDash &&
                                        (A.options.nullDataLineDashType || u === A.lineDashType && A.lineDashType !== A.nullDataLineDashType) && (s = t.pop(), u = t[t.length - 1], f(), c.moveTo(m.x, m.y), t.push(u), t.push(s), u = A.nullDataLineDashType, c.setLineDash(K)), c.lineTo(n, d), v && y.lineTo(n, d)) : (c.beginPath(), c.moveTo(n, d), v && (y.beginPath(), y.moveTo(n, d))), ca = s = !1) : (c.lineTo(n, d), v && y.lineTo(n, d), 0 == p % 250 && (f(), c.moveTo(n, d), v && y.moveTo(n, d), t.push({ x: n, y: q - ma })));
                                    m = { x: n, y: d };
                                    p < z.length - 1 && (L !== (z[p].lineColor || C) || u !== (z[p].lineDashType || A.lineDashType)) &&
                                        (f(), c.beginPath(), c.moveTo(n, d), t.push({ x: n, y: q - ma }), L = z[p].lineColor || C, c.strokeStyle = L, c.setLineDash && (z[p].lineDashType ? (u = z[p].lineDashType, c.setLineDash(F(u, A.lineThickness))) : (u = A.lineDashType, c.setLineDash(da))));
                                    if (0 <= A.dataPointIndexes[w]) {
                                        var E = A.dataPointIds[A.dataPointIndexes[w]];
                                        this._eventManager.objectMap[E] = { id: E, objectType: "dataPoint", dataSeriesIndex: B, dataPointIndex: A.dataPointIndexes[w], x1: n, y1: d };
                                    }
                                    0 <= A.dataPointIndexes[w] && 0 !== aa.markerSize && (0 < aa.markerSize || 0 < A.markerSize) &&
                                        (w = A.getMarkerProperties(p, n, d, c), h.push(w), markerColor = R(E), v && h.push({ x: n, y: d, ctx: y, type: w.type, size: w.size, color: markerColor, borderColor: markerColor, borderThickness: w.borderThickness }));
                                    (aa.indexLabel || A.indexLabel || aa.indexLabelFormatter || A.indexLabelFormatter) && this._indexLabels.push({ chartType: "stackedArea100", dataPoint: aa, dataSeries: A, point: { x: n, y: d }, direction: 0 > z[p].y === a.axisY.reversed ? 1 : -1, color: e });
                                }
                        }
                        f();
                        c.moveTo(n, d);
                ...
                c.restore();
                return { source: b, dest: this.plotArea.ctx, animationCallback: O.xClipAnimation, easingFunction: O.easing.linear,
                    animationBase: 0 };
            }
        };
        q.prototype.renderBubble = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                    ...
                    if (r = a.dataSeriesIndexes[k], p = this.data[r], n = p.dataPoints, 0 < n.length)
                        for (b.strokeStyle = "#4572A7 ", e = 0; e < n.length; e++)
                            if (g = n[e].getTime ?
                                ...
                                this._eventManager.objectMap[u] = { id: u, objectType: "dataPoint",
                                ...
                                (n[e].indexLabel || p.indexLabel || n[e].indexLabelFormatter || p.indexLabelFormatter) && this._indexLabels.push({ chartType: "bubble", dataPoint: n[e], dataSeries: p, point: { x: g, y: h }, direction: 1, bounds: { x1: g - d.size / 2, y1: h - d.size / 2, x2: g + d.size / 2, y2: h + d.size / 2 }, color: null });
                            }
                ...
                b.restore();
                return { source: f, dest: this.plotArea.ctx, animationCallback: O.fadeInAnimation, easingFunction: O.easing.easeInQuad, animationBase: 0 };
            }
        };
        ...
        q.prototype.renderCandlestick = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = null, g = null, h = this.plotArea, l = 0, t, k, r, p, n, d, e = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1, g = this.options.dataPointMaxWidth ?
                    this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : 0.015 * this.width, w = a.axisX.dataInfo.minDiff;
                    ...
                    if (0 < q.length)
                        for (var H = 5 < w && u.bevelEnabled ? !0 : !1, l = 0; l < q.length; l++)
                            if (q[l].getTime ? d = q[l].x.getTime() : d = q[l].x, !(d < a.axisX.dataInfo.viewPortMin || d > a.axisX.dataInfo.viewPortMax) && !y(q[l].y) && q[l].y.length &&
                                ...
                                var x = t - w / 2 << 0, B = x + w << 0, g = u.options.fallingColor ? u.fallingColor : u._colorSet[0], e = q[l].color ? q[l].color : u._colorSet[0], A = Math.round(Math.max(1, 0.15 * w)), z = 0 === A % 2 ? 0 : 0.5, C = u.dataPointIds[l];
                                this._eventManager.objectMap[C] =
                                    { id: C, objectType: "dataPoint", dataSeriesIndex: s, dataPointIndex: l, x1: x, y1: k, x2: B, y2: r, x3: t, y3: p, x4: t, y4: n, borderThickness: A, color: e };
                                b.strokeStyle = e;
                                b.beginPath();
                                b.lineWidth = A;
                                c.lineWidth = Math.max(A, 4);
                                "candlestick" === u.type ? (b.moveTo(t - z, r), b.lineTo(t - z, Math.min(k, n)), b.stroke(), b.moveTo(t - z, Math.max(k, n)), b.lineTo(t - z, p), b.stroke(), X(b, x, Math.min(k, n), B, Math.max(k, n), q[l].y[0] <= q[l].y[3] ? u.risingColor : g, A, e, H, H, !1, !1, u.fillOpacity), v && (e = R(C), c.strokeStyle = e, c.moveTo(t - z, r), c.lineTo(t - z, Math.min(k, n)), c.stroke(), c.moveTo(t - z, Math.max(k, n)), c.lineTo(t - z, p), c.stroke(), X(c, x, Math.min(k, n), B, Math.max(k, n), e, 0, null, !1, !1, !1, !1))) : "ohlc" === u.type && (b.moveTo(t - z, r), b.lineTo(t - z, p), b.stroke(), b.beginPath(), b.moveTo(t, k), b.lineTo(x, k), b.stroke(), b.beginPath(), b.moveTo(t, n), b.lineTo(B, n), b.stroke(), v && (e = R(C), c.strokeStyle = e, c.moveTo(t - z, r), c.lineTo(t - z, p), c.stroke(), c.beginPath(), c.moveTo(t, k), c.lineTo(x, k), c.stroke(), c.beginPath(), c.moveTo(t, n), c.lineTo(B, n), c.stroke()));
        ...
        q.prototype.renderBoxAndWhisker = function (a) {
            var f = a.targetCanvasCtx || this.plotArea.ctx, b = v ? this._preRenderCtx : f, c = this._eventManager.ghostCtx;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = null, g = this.plotArea, h = 0, l, t, k, r, p, n, d, e = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1, h = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : 0.015 * this.width, w = a.axisX.dataInfo.minDiff;
                isFinite(w) || (w = 0.3 * Math.abs(a.axisX.range));
                    ...
                    if (0 < H.length)
                        for (var x = 5 < w && q.bevelEnabled ? !0 : !1, h = 0; h < H.length; h++)
                            if (H[h].getTime ? d = H[h].x.getTime() : d = H[h].x, !(d < a.axisX.dataInfo.viewPortMin || d > a.axisX.dataInfo.viewPortMax) && !y(H[h].y) && H[h].y.length && "number" === typeof H[h].y[0] && "number" === typeof H[h].y[1] && "number" === typeof H[h].y[2] && "number" === typeof H[h].y[3] && "number" === typeof H[h].y[4] && 5 === H[h].y.length) {
                                ...
                                this._eventManager.objectMap[N] = { id: N, objectType: "dataPoint", dataSeriesIndex: u, dataPointIndex: h,
                        ...
                        for (var w = 5 < k && n.bevelEnabled ? !0 : !1, g = 0; g < d.length; g++)
                            if (d[g].getTime ? t = d[g].x.getTime() : t = d[g].x, !(t < a.axisX.dataInfo.viewPortMin || t > a.axisX.dataInfo.viewPortMax) && !y(d[g].y) && d[g].y.length && "number" === typeof d[g].y[0] && "number" === typeof d[g].y[1]) {
                                ...
                                var m = a.axisX.reversed ? c + a.plotType.totalDataSeries * k / 2 - (a.previousDataSeriesCount + r) * k << 0 : c - a.plotType.totalDataSeries * k / 2 + (a.previousDataSeriesCount +
                                    r) * k << 0, q = a.axisX.reversed ? m - k << 0 : m + k << 0, c = d[g].color ? d[g].color : n._colorSet[g % n._colorSet.length];
                                if (h > l) {
                                    var u = h;
                                    h = l;
                                    l = u;
                    ...
                    for (var s = 0; s < a.dataSeriesIndexes.length; s++) {
                        ...
                        if (0 < B.length)
                            for (var F = x._colorSet, l = 0; l < B.length; l++) {
                                var e = x.lineColor = x.options.color ? x.options.color : F[0], L = { color: B[l].whiskerColor ? B[l].whiskerColor : B[l].color ? x.whiskerColor ? x.whiskerColor : B[l].color : x.whiskerColor ? x.whiskerColor : e, thickness: y(B[l].whiskerThickness) ? x.whiskerThickness : B[l].whiskerThickness, dashType: B[l].whiskerDashType ? B[l].whiskerDashType : x.whiskerDashType, length: y(B[l].whiskerLength) ? y(x.options.whiskerLength) ? u : x.options.whiskerLength : B[l].whiskerLength,
                                ...
                                var K = { color: B[l].stemColor ? B[l].stemColor : B[l].color ? x.stemColor ? x.stemColor : B[l].color : x.stemColor ? x.stemColor : e, thickness: B[l].stemThickness ? B[l].stemThickness : x.stemThickness, dashType: B[l].stemDashType ?
                                ...
                                if (!(w < a.axisX.dataInfo.viewPortMin || w > a.axisX.dataInfo.viewPortMax) && !y(B[l].y) && B[l].y.length && "number" === typeof B[l].y[0] && "number" === typeof B[l].y[1]) {
                                    ...
                                    c && r > p && (da = r, r = p, p = da);
                                    da = x.dataPointIds[l];
                                    this._eventManager.objectMap[da] = { id: da, objectType: "dataPoint", dataSeriesIndex: H, dataPointIndex: l, x1: Math.min(r, p), y1: Math.min(n, d), x2: Math.max(p, r), y2: Math.max(d, n), isXYSwapped: c, stemProperties: K, whiskerProperties: L };
                                    ...
                                    if (B[l].indexLabel || x.indexLabel || B[l].indexLabelFormatter || x.indexLabelFormatter)
                                        this._indexLabels.push({ chartType: "error", dataPoint: B[l], dataSeries: x, indexKeyword: 0, point: { x: c ? B[l].y[1] >= B[l].y[0] ? r : p : r + (p - r) / 2, y: c ? n + (d - n) / 2 : B[l].y[1] >= B[l].y[0] ? d : n }, direction: B[l].y[1] >= B[l].y[0] ? -1 : 1, bounds: { x1: c ? Math.min(r, p) : r, y1: c ? n : Math.min(n, d), x2: c ? Math.max(r, p) : p, y2: c ? d : Math.max(n, d) }, color: e, axisSwapped: c }),
        ...
        q.prototype.renderRangeBar = function (a) {
            var f = a.targetCanvasCtx || this.plotArea.ctx, b = v ? this._preRenderCtx :
                f;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var c = null, e = this.plotArea, g = 0, h, l, t, k, g = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1;
                            ...
                            if (w[g].getTime ? k = w[g].x.getTime() : k = w[g].x, !(k < a.axisX.dataInfo.viewPortMin || k > a.axisX.dataInfo.viewPortMax) && !y(w[g].y) && w[g].y.length && "number" === typeof w[g].y[0] && "number" === typeof w[g].y[1]) {
                                ...
                                if (w[g].indexLabel || d.indexLabel || w[g].indexLabelFormatter || d.indexLabelFormatter)
                                    this._indexLabels.push({ chartType: "rangeBar", dataPoint: w[g], dataSeries: d, indexKeyword: 0, point: { x: w[g].y[1] >= w[g].y[0] ? h : l, y: t + (q - t) / 2 }, direction: w[g].y[1] >= w[g].y[0] ? -1 : 1, bounds: { x1: Math.min(h, l), y1: t, x2: Math.max(h, l), y2: q }, color: c }), this._indexLabels.push({ chartType: "rangeBar", dataPoint: w[g], dataSeries: d, indexKeyword: 1, point: { x: w[g].y[1] >=
                                                w[g].y[0] ? l : h, y: t + (q - t) / 2 }, direction: w[g].y[1] >= w[g].y[0] ? 1 : -1, bounds: { x1: Math.min(h, l), y1: t, x2: Math.max(h, l), y2: q }, color: c });
                            }
                    }
                }
                v && (f.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && b.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && b.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.clearRect(e.x1, e.y1, e.width, e.height), this._eventManager.ghostCtx.restore());
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var l = 0; l < a.dataSeriesIndexes.length; l++) {
                    ...
                    if (0 < p.length) {
                        ...
                        var A = "solid";
                        if (c.setLineDash) {
                            var z = F(r.nullDataLineDashType, r.lineThickness), A = r.lineDashType, C = F(A, r.lineThickness);
                            c.setLineDash(C);
                        }
                        for (var L = !0; d <
                            p.length; d++)
                            if (u = p[d].x.getTime ? p[d].x.getTime() : p[d].x, !(u < a.axisX.dataInfo.viewPortMin || u > a.axisX.dataInfo.viewPortMax && (!r.connectNullData || !L)))
                                if (null !== p[d].y && p[d].y.length && "number" === typeof p[d].y[0] && "number" === typeof p[d].y[1]) {
                                    ...
                                    n || L ? (r.connectNullData && !n ? (c.setLineDash && (r.options.nullDataLineDashType || A === r.lineDashType && r.lineDashType !== r.nullDataLineDashType) && (t[t.length -
                                        1].newLineDashArray = C, A = r.nullDataLineDashType, c.setLineDash(z)), c.lineTo(w, m), v && e.lineTo(w, m), t.push({ x: w, y: q })) : (c.beginPath(), c.moveTo(w, m), s = { x: w, y: m }, t = [], t.push({ x: w, y: q }), v && (e.beginPath(), e.moveTo(w, m))), L = n = !1) : (c.lineTo(w, m), t.push({ x: w, y: q }), v && e.lineTo(w, m), 0 == d % 250 && f());
                                    u = r.dataPointIds[d];
                                    ...
                                    if (0 !== p[d].markerSize && (0 < p[d].markerSize || 0 < r.markerSize)) {
                                        ...
                                        g.push(K);
                                        var da = R(u);
                                        v && g.push({ x: w, y: q, ctx: e, type: K.type, size: K.size, color: da, borderColor: da, borderThickness: K.borderThickness });
                                        K = r.getMarkerProperties(d, w, m, c);
                                        g.push(K);
                                        da = R(u);
                                        v && g.push({ x: w, y: m, ctx: e, type: K.type, size: K.size, color: da, borderColor: da, borderThickness: K.borderThickness });
                                    }
                                    if (p[d].indexLabel || r.indexLabel || p[d].indexLabelFormatter || r.indexLabelFormatter)
                                        this._indexLabels.push({ chartType: "rangeArea", dataPoint: p[d], dataSeries: r, indexKeyword: 0, point: { x: w, y: m }, direction: p[d].y[0] > p[d].y[1] === a.axisY.reversed ? -1 : 1, color: y }), this._indexLabels.push({ chartType: "rangeArea", dataPoint: p[d], dataSeries: r, indexKeyword: 1, point: { x: w,
                                                y: q }, direction: p[d].y[0] > p[d].y[1] === a.axisY.reversed ? 1 : -1, color: y });
                                }
                                else
                                    L || n || f(), L = !0;
                        f();
                        ...
                        for (d = !1; p < r.length; p++)
                            if (n = r[p].x.getTime ? r[p].x.getTime() : r[p].x, !(n < a.axisX.dataInfo.viewPortMin || n > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !d)))
                                if (null !== r[p].y && r[p].y.length && "number" === typeof r[p].y[0] && "number" === typeof r[p].y[1]) {
                                    ...
                                    this._eventManager.objectMap[C] = { id: C, objectType: "dataPoint", dataSeriesIndex: t, dataPointIndex: p,
                                        x1: n, y1: d, y2: w };
                                    m[m.length] = { x: n, y: d };
                                    q[q.length] = { x: n, y: w };
                                    ...
                                    if (0 !== r[p].markerSize && (0 < r[p].markerSize || 0 < k.markerSize)) {
                                        ...
                                        g.push(la);
                                        var L = R(C);
                                        v && g.push({ x: n, y: d, ctx: e,
                                            type: la.type, size: la.size, color: L, borderColor: L, borderThickness: la.borderThickness });
                                        la = k.getMarkerProperties(p, n, w, c);
                                        g.push(la);
                                        L = R(C);
                                        v && g.push({ x: n, y: w, ctx: e, type: la.type, size: la.size, color: L, borderColor: L, borderThickness: la.borderThickness });
                                    }
                                    if (r[p].indexLabel || k.indexLabel || r[p].indexLabelFormatter || k.indexLabelFormatter)
                                        this._indexLabels.push({ chartType: "rangeSplineArea", dataPoint: r[p], dataSeries: k, indexKeyword: 0, point: { x: n, y: d }, direction: r[p].y[0] <= r[p].y[1] ? -1 : 1, color: u }), this._indexLabels.push({ chartType: "rangeSplineArea",
                                            dataPoint: r[p], dataSeries: k, indexKeyword: 1, point: { x: n, y: w }, direction: r[p].y[0] <= r[p].y[1] ? 1 : -1, color: u });
                                    d = !1;
                                }
                                else
                                    0 < p && !d && (k.connectNullData ? c.setLineDash && (0 < m.length && (k.options.nullDataLineDashType || !r[p - 1].lineDashType)) && (m[m.length - 1].newLineDashArray = A, z = k.nullDataLineDashType) : (f(B, s), m = [], q = [])), d = !0;
                        f(B, s);
                        $.drawMarkers(g);
                    }
                }
        ...
        q.prototype.renderWaterfall = function (a) {
            var f = a.targetCanvasCtx || this.plotArea.ctx, b = v ? this._preRenderCtx :
                f;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var c = this._eventManager.ghostCtx, e = null, g = this.plotArea, h = 0, l, t, k, r, p = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), h = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1;
                        ...
                        for (var y = 5 < n && m.bevelEnabled ? !0 : !1, x = !1, z = null, A = null, h = 0; h < q.length; h++)
                            if (q[h].getTime ? r = q[h].x.getTime() : r = q[h].x, "number" !== typeof q[h].y) {
                                if (0 < h && !x && m.connectNullData)
                                    var C = m.options.nullDataLineDashType || !q[h - 1].lineDashType ? m.nullDataLineDashType : q[h - 1].lineDashType;
                                x = !0;
                            }
                            else {
                                ...
                                e = m.dataPointIds[h];
                                this._eventManager.objectMap[e] = { id: e, objectType: "dataPoint", dataSeriesIndex: w, dataPointIndex: h, x1: l, y1: t, x2: la, y2: k };
                                ...
                                (q[h].indexLabel || m.indexLabel || q[h].indexLabelFormatter || m.indexLabelFormatter) && this._indexLabels.push({ chartType: "waterfall", dataPoint: q[h], dataSeries: m, point: { x: l + (la - l) / 2, y: 0 <= q[h].y ? t : k }, direction: 0 > q[h].y === a.axisY.reversed ?
        ...
        q.prototype.renderPie = function (a) {
            ...
            function b(a) {
                ...
                for (b = b = 0; b < r.length; b++)
                    c = d[b], c.indexLabelText && (c.indexLabelTextBlock.y -= c.indexLabelTextBlock.height / 2, e = 0, e = "left" === c.hemisphere ? "inside" !== k.indexLabelPlacement ? -(c.indexLabelTextBlock.width +
                        p) : -c.indexLabelTextBlock.width / 2 : "inside" !== k.indexLabelPlacement ? p : -c.indexLabelTextBlock.width / 2, c.indexLabelTextBlock.x += e, c.indexLabelTextBlock.render(!0), c.indexLabelTextBlock.x -= e, c.indexLabelTextBlock.y += c.indexLabelTextBlock.height / 2, "inside" !== c.indexLabelPlacement && 0 < c.indexLabelLineThickness && (e = c.center.x + A * Math.cos(c.midAngle), f = c.center.y + A * Math.sin(c.midAngle), a.strokeStyle = c.indexLabelLineColor, a.lineWidth = c.indexLabelLineThickness, a.setLineDash && a.setLineDash(F(c.indexLabelLineDashType, c.indexLabelLineThickness)), a.beginPath(), a.moveTo(e, f), a.lineTo(c.indexLabelTextBlock.x, c.indexLabelTextBlock.y), a.lineTo(c.indexLabelTextBlock.x + ("left" === c.hemisphere ? -p : p), c.indexLabelTextBlock.y), a.stroke()), a.lineJoin = "miter");
                a.save();
            }
            function c(a, b) {
            ...
            function e(a) { for (var b = null, e = 1; e < r.length; e++)
                ...
                if (0 <= a && a < r.length) {
                    ...
                    for (n = 1; n < r.length; n++)
                        if (h = (a - n + d.length) % d.length, d[h].hemisphere !== d[a].hemisphere) {
                            ...
                            ("right" === d[a].hemisphere ? d[h].indexLabelTextBlock.y <= d[a].indexLabelTextBlock.y : d[h].indexLabelTextBlock.y >= d[a].indexLabelTextBlock.y)))
                            break;
                        else
                            h = null;
                    p = h;
            ...
            function h() {
                ...
                for (var b = a = 0, f = 0, h = !0, b = 0; 10 > b && (1 > b || 0 < f); b++) {
                    ...
                    if ("inside" !== k.indexLabelPlacement) {
                            ...
                            if (null !== z) {
                                ...
                                if (0 > B) {
                                    for (var F = y = 0, sa = 0; sa < r.length; sa++)
                                        sa !== a && d[sa].hemisphere === l.hemisphere && (d[sa].indexLabelTextBlock.y < l.indexLabelTextBlock.y ? y++ : F++);
                                    y = B / (y + F || 1) * F;
                                    var F = -1 * (B - y), J = sa = 0;
                        ...
                        for (a = 0; a < r.length; a++)
                            l = d[a], q = "pie" === k.type ? 0.7 * A : 0.8 * A, z = x.x + q * Math.cos(l.midAngle), y = x.y + q * Math.sin(l.midAngle), l.indexLabelTextBlock.x = z, l.indexLabelTextBlock.y = y;
                    for (a = 0; a < r.length; a++)
                        if (l = d[a], z = l.indexLabelTextBlock.measureText(), 0 !== z.height && 0 !== z.width)
                            z = z = 0, "right" === l.hemisphere ? (z = n.x2 - (l.indexLabelTextBlock.x + l.indexLabelTextBlock.width + p), z *= -1) : z = n.x1 - (l.indexLabelTextBlock.x -
                    ...
                    var M = function (a, b, c) {
                        ...
                        for (b = 0; b < e.length; b++)
                            if (c = e[b], f < 0.7 * a)
                                f += c.indexLabelTextBlock.height, c.indexLabelTextBlock.text = "", c.indexLabelText = "", c.indexLabelTextBlock.measureText();
                            else
                                break;
                    };
                    (function () {
                            ...
                            if (g = !1, u = d[h], u.indexLabelText) {
                                ...
                                if (null !== k) {
                                    ...
                                    if (n = 0 > B) {
                                        ...
                                        var t = u.indexLabelTextBlock.y - u.indexLabelTextBlock.height / 2, m = u.indexLabelTextBlock.y + u.indexLabelTextBlock.height /
                                            2, w = l.indexLabelTextBlock.y - l.indexLabelTextBlock.height / 2, q = l.indexLabelTextBlock.x + l.indexLabelTextBlock.width, s = l.indexLabelTextBlock.y + l.indexLabelTextBlock.height / 2;
                ...
                if (0 !== z) {
                    ...
                    this._animator.animate(0, this.animatedRender ? this.animationDuration : 0, function (a) {
                        ...
                        for (b = 0; b < r.length; b++) {
                            ...
                            e > c && pa(t.plotArea.ctx, d[b].center, d[b].radius, g, k.type, c, e, k.fillOpacity, d[b].percentInnerRadius);
                            if (f)
                                break;
                        }
                        l();
        ...
        q.prototype.renderFunnel = function (a) {
            function f() { for (var a = 0, b = [], c = 0; c < x.length; c++) {
                ...
                b.push(Math.abs(x[c].y) * J / a); return b; }
            function b() {
                ...
                for (var k = d[0] = 0, l = 0, n, b = b - a, t = !1, h = 0; h < x.length; h++)
                    a = Math.abs(x[h].y) * f / g, t ? k = 0 == Number(c.toFixed(3)) ? 0 : a / c : (sqrt = ea * ea * b * b - 4 * Math.abs(ea) * a, 0 > sqrt ? (n = c, k = (b + n) * (e - l) / 2, a -= k, k = e - l, l += e - l, k += 0 == n ? 0 : a / n, l += a / n, t = !0) : (k = (Math.abs(ea) * b - Math.sqrt(sqrt)) / 2, n = b - 2 * k / Math.abs(ea), l += k, l > e && (l -= k, n = c,
                        k = (b + n) * (e - l) / 2, a -= k, k = e - l, l += e - l, k += a / n, l += a / n, t = !0), b = n)), d.push(k);
                return d;
            }
            function c() {
                if (u && x) {
                    for (var a, b, c, e, f, g, h, k, l, n, t, p, r, m, w = [], q = [], z = { percent: null, total: null }, A = null, B = 0; B < x.length; B++)
                        m = N[B], m = "undefined" !== typeof m.x5 ? (m.y2 + m.y4) / 2 : (m.y2 + m.y3) / 2, m = d(m).x2 + 1, w[B] = S - m - U;
                    m = 0.5 * U;
                    for (var B = 0, ya = x.length - 1; B < x.length || 0 <= ya; B++, ya--) {
                        ...
                        r = u.dataPointIds[B];
                        s._eventManager.objectMap[r] = { id: r, objectType: "dataPoint", dataPointIndex: B, dataSeriesIndex: 0, funnelSection: N[u.reversed ? x.length - 1 - B : B] };
                        ...
                        if (u.indexLabelFormatter || b.indexLabelFormatter)
                            A = { chart: s.options, dataSeries: u, dataPoint: b, total: z.total, percent: z.percent };
                        ...
                        R.roundRect || Ba(R);
                        c = new ka(R, { fontSize: g, fontFamily: k, fontColor: f, fontStyle: h, fontWeight: l, horizontalAlign: c, backgroundColor: e, maxWidth: r, maxHeight: !1 === q[B] ? p ? 4.28571429 * g : 1.5 * g : q[B], text: b, padding: ga });
                        c.measureText();
                        G.push({ textBlock: c, id: u.reversed ? ya : B, isDirty: !1, lineColor: a, lineThickness: n,
            ...
            function g() {
                ...
                if ("inside" !== u.indexLabelPlacement)
                    for (var f = 0; f < N.length; f++)
                        0 == G[f].textBlock.text.length ? G[f].isDirty = !0 : (a = N[f], c = "undefined" !== typeof a.x5 ? (a.y2 + a.y4) / 2 : (a.y2 + a.y3) / 2, b = u.reversed ? "undefined" !== typeof a.x5 ? c > ba ? d(c).x2 + 1 : (a.x2 + a.x3) / 2 + 1 : (a.x2 + a.x3) / 2 + 1 : "undefined" !== typeof a.x5 ? c < ba ? d(c).x2 + 1 : (a.x4 + a.x3) / 2 + 1 : (a.x2 + a.x3) / 2 + 1, G[f].textBlock.x = b + U, G[f].textBlock.y =
                    ...
                    for (f = 0; f < N.length; f++)
                        0 == G[f].textBlock.text.length ? G[f].isDirty = !0 : (a = N[f], b = a.height, c = G[f].height, e = G[f].width, b >= c ? (b = f != fa ? (a.x4 + a.x3) / 2 - e / 2 : (a.x5 + a.x4) / 2 - e / 2, c = f != fa ? (a.y1 + a.y3) / 2 - c / 2 : (a.y1 + a.y4) / 2 - c / 2, G[f].textBlock.x = b, G[f].textBlock.y =
                            c) : G[f].isDirty = !0);
            }
            function h() {
                function a(b, c) { var d; if (0 > b || b >= G.length)
                    return 0; var e, f = G[b].textBlock; if (0 > c) {
                    c *= -1;
                    e = p(b);
                    d = l(e, b);
                    if (d >= c)
                    ...
                    return f.y += c, c; if (b == N.length - 1)
                ...
                function b() {
                    ...
                    for (var k, l = 1; l < h; l++) {
                        ...
                        for (var r = G.length - 1; 0 <= r; r--)
                            !G[r].isDirty && (G[r].textBlock.y < e && G[r].textBlock.y +
                ...
                function c(a, b, d) { var e = [], f = 0, g = 0; for (a = Math.abs(a); d <= b; d++)
                    e.push(N[d]); e.sort(function (a, b) { return a.height - b.height; }); for (d = 0; d < e.length; d++)
                    if (b = e[d], f < a)
                        g++, f += G[b.id].height + ga, G[b.id].textBlock.text = "", G[b.id].indexLabelText = "", G[b.id].isDirty = !0, G[b.id].textBlock.measureText();
                    else
                        break; return g; }
            ...
            function l(a, b) { return (b < N.length ? G[b].textBlock.y : u.reversed ? T + C : ra + C) - (0 > a ? u.reversed ? ra - C : T - C : G[a].textBlock.y + G[a].height + ga); }
            function t(a, b, c) {
                var d, e, f, h = [], l = C, n = [];
                -1 !== b && (0 <= $.indexOf(b) ? (e = $.indexOf(b), $.splice(e, 1)) : ($.push(b), $ = $.sort(function (a, b) { return a - b; })));
                if (0 === $.length)
                    h = ja;
                else {
                ...
                var p = { startTime: (new Date).getTime(), duration: c || 500, easingFunction: function (a, b, c, d) { return O.easing.easeOutQuart(a, b, c, d); }, changeSection: function (a) {
            ...
            function k() { for (var a = 0, b = 0; b < N.length - 1; b++)
                (0 <= $.indexOf(b) || 0 <= $.indexOf(b + 1)) && a++; return a; }
            function r(a) {
                for (var b, c, e, f, g = 0; g < N.length; g++)
                    f = 1 === G[g].lineThickness % 2 ? 0.5 : 0, c = ((N[g].y2 + N[g].y4) / 2 << 0) + f, b = d(c).x2 - 1, e = G[g].textBlock.x, f = (G[g].textBlock.y + G[g].height / 2 << 0) + f, G[g].isDirty ||
            ...
            function p(a) { for (a -= 1; -1 <= a && -1 != a && G[a].isDirty; a--)
                ; return a; }
            function n(a) { for (a += 1; a <= N.length && a != N.length && G[a].isDirty; a++)
                ; return a; }
            function d(a) {
            ...
            function m(a) { for (var b = 0; b < N.length; b++)
                ...
                if (s.subtitles)
                    for (var b = 0; b < s.subtitles.length; b++) {
                        ...
                        if (c.dockInsidePlotArea || "center" ===
                            c.horizontalAlign && "center" === c.verticalAlign)
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                for (var u = this.data[a.dataSeriesIndexes[0]], x = u.dataPoints, z = this.plotArea, C = 0.025 * z.width, B = 0.01 * z.width, A = 0, J = z.height - 2 * C, I = Math.min(z.width - 2 * B, 2.8 * z.height), L = !1, K = 0; K < x.length; K++)
                    if (!L && ("undefined" !== typeof x[K].indexLabel &&
                        null !== x[K].indexLabel && 0 < x[K].indexLabel.toString().length) && (L = !0), !L && ("undefined" !== typeof x[K].label && null !== x[K].label && 0 < x[K].label.toString().length) && (L = !0), !L && "function" === typeof u.indexLabelFormatter || "function" === typeof x[K].indexLabelFormatter)
                        L = !0;
                ...
                var K = z.x1 + B, S = z.x2 - B, ca = z.y1 + C, aa = z.y2 - C, R = a.targetCanvasCtx || this.plotArea.ctx || this.ctx;
                if (0 != u.length && (u.dataPoints && u.visible) && 0 !== x.length) {
                    ...
                    a = [];
                    var B = [], N = [], I = [], V = ca, fa, ea = (ba - T) / (M - Y), ha = -ea, K = "area" === (u.valueRepresents ? u.valueRepresents : "height") ? b() : f();
                    if (-1 !== K) {
                        if (u.reversed)
                        ...
                        if (u.reversed)
                            for (E = 0; E < K.length; E++)
                                I[E] < ba ? (a.push(M), B.push(Z), fa = E) : (a.push((I[E] - T + ea * Y) / ea), B.push((I[E] - T + ha * X) / ha));
                        else
                            for (E = 0; E < K.length; E++)
                                I[E] < ba ? (a.push((I[E] - T + ea * Y) / ea), B.push((I[E] - T + ha *
                                    X) / ha), fa = E) : (a.push(M), B.push(Z));
                        for (E = 0; E < K.length - 1; E++)
                            V = u.reversed ? x[x.length - 1 - E].color ? x[x.length - 1 - E].color : u._colorSet[(x.length - 1 - E) % u._colorSet.length] : x[E].color ? x[E].color : u._colorSet[E % u._colorSet.length], E === fa ? N.push({ x1: a[E], y1: I[E], x2: B[E], y2: I[E], x3: Z, y3: ba, x4: B[E + 1], y4: I[E + 1], x5: a[E + 1], y5: I[E + 1], x6: M, y6: ba, id: E, height: I[E + 1] - I[E], color: V }) : N.push({ x1: a[E], y1: I[E], x2: B[E], y2: I[E], x3: B[E + 1], y3: I[E + 1], x4: a[E + 1], y4: I[E + 1], id: E, height: I[E + 1] - I[E], color: V });
                        var ga = 2, G = [], ia = !1, $ = [], ja = [], K = !1;
                        a = a = 0;
                        Ca($);
                        ...
                        if (L && u.visible && (c(), g(), e(), "inside" !== u.indexLabelPlacement)) {
                            h();
                            for (E = 0; E < x.length; E++)
                                G[E].isDirty || (a = G[E].textBlock.x + G[E].width, a = (S - a) / 2, 0 == E && (A = a), A > a && (A = a));
                            for (E = 0; E < N.length; E++)
                                N[E].x1 += A, N[E].x2 += A, N[E].x3 += A, N[E].x4 += A, N[E].x5 && (N[E].x5 += A, N[E].x6 += A), G[E].textBlock.x +=
                                    A;
                        }
                        for (E = 0; E < N.length; E++)
        ...
        q.prototype.requestAnimFrame =
            function () { return window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.oRequestAnimationFrame || window.msRequestAnimationFrame || function (a) { window.setTimeout(a, 1E3 / 60); }; }();
        ...
        q.prototype.exportChart = function (a) { a = "undefined" === typeof a ? {} : a; var f = a.format ? a.format : "png", b = a.fileName ? a.fileName : this.exportFileName; if (a.toDataURL)
            return this.canvas.toDataURL("image/" + f); s(this.canvas, f, b); };
        ...
        q.prototype.getPercentAndTotal = function (a, f) {
            ...
            if (0 <= a.type.indexOf("stacked"))
                c = 0, b = f.x.getTime ? f.x.getTime() : f.x, b in a.plotUnit.yTotals && (c = a.plotUnit.yTotals[b], e = isNaN(f.y) ? 0 : 100 * (f.y / c));
                ...
                if ("x" === a)
                    if ("dateTime" === b.axisX.valueType || "dateTime" === b.xValueType || f.x && f.x.getTime) {
                        if (g.plotInfo.plotTypes[0].plotUnits[0].axisX && !g.plotInfo.plotTypes[0].plotUnits[0].axisX.logarithmic)
                            return Aa(d, f.xValueFormatString ?
                        ...
                        return V(d, f.xValueFormatString ? f.xValueFormatString : b.xValueFormatString ? b.xValueFormatString : b.xValueFormatString = "#,##0.########", g._cultureInfo);
                else
                    return "y" === a ? V(d, f.yValueFormatString ? f.yValueFormatString : b.yValueFormatString ? b.yValueFormatString : b.yValueFormatString = "#,##0.########", g._cultureInfo) : "z" ===
        ...
        T.prototype.render = function () {
                ...
                if (n.dataPoints &&
                    ...
                    if ("pie" !== n.type && "doughnut" !== n.type && "funnel" !== n.type && "pyramid" !== n.type) {
                        ...
                        for (var x = 0; x < n.dataPoints.length; x++) {
                            var z = n.dataPoints[x], d = z.legendMarkerType ? z.legendMarkerType : n.legendMarkerType ? n.legendMarkerType : S.getDefaultLegendMarker(n.type), m = z.legendText ? z.legendText : n.legendText ? n.legendText : this.itemTextFormatter ? this.itemTextFormatter({ chart: this.chart, legend: this.options, dataSeries: n, dataPoint: z }) : z.name ? z.name : "DataPoint: " + (x + 1), q = z.legendMarkerColor ? z.legendMarkerColor : n.legendMarkerColor ? n.legendMarkerColor : z.color ? z.color : n.color ? n.color : n._colorSet[x % n._colorSet.length], s = 0.75 * this.lineHeight, u = z.legendMarkerBorderColor ? z.legendMarkerBorderColor : n.legendMarkerBorderColor ? n.legendMarkerBorderColor : z.markerBorderColor ? z.markerBorderColor :
            ...
            if (0 < t.length) {
                ...
                for (p = 0; p < t.length; p++) {
                    ...
                    if (!(0 >= h || "undefined" === typeof h || 0 >= q || "undefined" === typeof q)) {
                        if ("horizontal" ===
                            this.orientation) {
                            d.textBlock = new ka(this.ctx, { x: 0, y: 0, maxWidth: q, maxHeight: this.itemWrap ? h : this.lineHeight, angle: 0, text: d.text, horizontalAlign: "left", fontSize: this.fontSize, fontFamily: this.fontFamily, fontWeight: this.fontWeight, fontColor: this.fontColor, fontStyle: this.fontStyle, textBaseline: "middle" });
                            ...
                            if (!n || n.width +
                                Math.round(d.textBlock.width + s + l + (0 === n.width ? 0 : this.horizontalSpacing) + ("line" === d.chartType || "spline" === d.chartType || "stepLine" === d.chartType ? 2 * 0.1 * this.lineHeight : 0)) > g)
                                n = { items: [], width: 0 }, k.push(n), this.height += x, x = 0;
                            x = Math.max(x, d.textBlock.height);
                        }
                        else
                            d.textBlock = new ka(this.ctx, { x: 0, y: 0, maxWidth: z, maxHeight: !0 === this.itemWrap ? h : 1.5 * this.fontSize, angle: 0, text: d.text, horizontalAlign: "left", fontSize: this.fontSize, fontFamily: this.fontFamily, fontWeight: this.fontWeight, fontColor: this.fontColor,
                                fontStyle: this.fontStyle, textBaseline: "middle" }), d.textBlock.measureText(), null !== this.itemWidth && (d.textBlock.width = this.itemWidth - (s + l + ("line" === d.chartType || "spline" === d.chartType || "stepLine" === d.chartType ? 2 * 0.1 * this.lineHeight : 0))), this.height < h - this.lineHeight ? (n = { items: [], width: 0 }, k.push(n)) : (n = k[v], v = (v + 1) % k.length), this.height += d.textBlock.height;
            ...
            for (p = 0; p < this.items.length; p++)
                d = t[p], d.id = ++this.chart._eventManager.lastObjectId, this.chart._eventManager.objectMap[d.id] =
                    { id: d.id, objectType: "legendItem", legendItemIndex: p, dataSeriesIndex: d.dataSeriesIndex, dataPointIndex: d.dataPointIndex };
        ...
        S.prototype.getDefaultAxisPlacement = function () {
            ...
            if ("column" === a || "line" === a || "stepLine" === a || "spline" === a || "area" === a || "stepArea" === a || "splineArea" === a || "stackedColumn" === a || "stackedLine" === a || "bubble" === a || "scatter" === a || "stackedArea" === a || "stackedColumn100" === a || "stackedLine100" === a || "stackedArea100" === a || "candlestick" === a || "ohlc" === a || "rangeColumn" === a || "rangeArea" ===
                a || "rangeSplineArea" === a || "boxAndWhisker" === a || "waterfall" === a)
                return "normal";
        ...
        S.getDefaultLegendMarker = function (a) {
            if ("column" === a || "stackedColumn" === a || "stackedLine" === a || "bar" === a || "stackedBar" === a || "stackedBar100" === a || "bubble" === a || "scatter" === a || "stackedColumn100" === a ||
                "stackedLine100" === a || "stepArea" === a || "candlestick" === a || "ohlc" === a || "rangeColumn" === a || "rangeBar" === a || "rangeArea" === a || "rangeSplineArea" === a || "boxAndWhisker" === a || "waterfall" === a)
                return "square";
        ...
        S.prototype.getDataPointAtXY =
            function (a, f, b) {
                if (!this.dataPoints || 0 === this.dataPoints.length || a < this.chart.plotArea.x1 || a > this.chart.plotArea.x2 || f < this.chart.plotArea.y1 || f > this.chart.plotArea.y2)
                    return null;
                b = b || !1;
                ...
                if ("none" !== this.chart.plotInfo.axisPlacement)
                    if (p = (this.chart.axisX[0] ? this.chart.axisX[0] : this.chart.axisX2[0]).getXValueAt({ x: a, y: f }), this.axisX.logarithmic)
                        var n = Math.log(this.dataPoints[this.dataPoints.length - 1].x / this.dataPoints[0].x), p = 1 < n ? Math.min(Math.max((this.dataPoints.length -
                    ...
                    if (0 <= g && g < this.dataPoints.length) {
                        ...
                        if (n) {
                            switch (this.type) {
                                ...
                                case "splineArea":
                                case "scatter":
                                    var q = ja("markerSize", d, this) || 4, s = b ? 20 : q, m = Math.sqrt(Math.pow(n.x1 - a, 2) + Math.pow(n.y1 - f, 2));
        ...
        C.prototype.createLabels = function () {
            ...
            if ("axisX" !== this.type || "dateTime" !== this.valueType || this.logarithmic) {
                ...
                for (b = this.intervalStartPosition; b <= e; b = parseFloat(1E-12 > this.interval ? this.logarithmic && this.equidistantInterval ?
                    ...
                    a = d < p.length && b >= p[d].startValue && b <= p[d].endValue;
                    m = b;
                    a || (a = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.options, value: m, label: this.labels[m] ? this.labels[m] : null }) : "axisX" === this.type && this.labels[m] ? this.labels[m] : V(m, this.valueFormatString, this.chart._cultureInfo),
        ...
        C.setLayoutAndRender = function (a, f, b, c, e, g) {
            ...
            for (var x = s = 0, u = 0, z = 0, C = 0, F = 0, B = 0, A, I, J = l = 0, L, K, O, q = L = K = O = !1, d = 0; d < n.length; d++)
            ...
            if ("normal" === e) {
                for (var z = [], C = [], F = [], B = [], P = [], R = [], S = [], T = []; 4 > s;) {
                    ...
                    if (f && 0 < f.length)
                        for (d = 0; d < f.length; d++)
                            f[d].lineCoordinates.x1 = Math.round(g.x1 + N + M), f[d].lineCoordinates.x2 =
                    ...
                    if (b && 0 < b.length)
                        for (d = 0; d < b.length; d++)
                            M = 10, b[d] && (h = Math.round(a[0] ? a[0].lineCoordinates.x1 : f[0].lineCoordinates.x1), M = b[d]._labels && 0 < b[d]._labels.length ?
                    ...
                    if (c && 0 < c.length)
                        for (d = 0; d < c.length; d++)
                            c[d] && (h = Math.round(a[0] ? a[0].lineCoordinates.x2 : f[0].lineCoordinates.x2), t = Math.round(h), M = c[d]._labels && 0 < c[d]._labels.length ? c[d]._labels[c[d]._labels.length - 1].textBlock.height / 2 : 0, l = Math.round(g.y1 + V + W < Math.max(M, 10) ? Math.max(M, 10) : g.y1 + V + W), M = 0 < a.length ? 0 : c[d]._labels && 0 < c[d]._labels.length ? c[d]._labels[0].textBlock.height / 2 : 0, k = Math.round(g.y2 - (Z + e + M)), c[d].lineCoordinates =
                                { x1: h + X, y1: l, x2: h + X, y2: k, height: Math.abs(k - l) }, c[d].bounds = { x1: h, y1: l, x2: t + (B[d] + X), y2: k, width: t - h, height: k - l }, c[d].title && (c[d]._titleTextBlock.maxWidth = 0 < c[d].titleMaxWidth && c[d].titleMaxWidth < c[d].lineCoordinates.height ? c[d].titleMaxWidth : c[d].lineCoordinates.height), X += B[d] + c[d].margin);
                    if (a && 0 < a.length)
                        for (d = 0; d < a.length; d++)
                ...
                for (S = []; 4 > s;) {
                    ...
                    if (f && 0 < f.length)
                        for (I = [], d = V = 0; d < f.length; d++)
                            I.push(Math.ceil(f[d] ? f[d].createLabelsAndCalculateWidth() : 0)), V += I[d], W += f[d] ? f[d].margin : 0;
                    else
                    ...
                    if (b && 0 < b.length)
                        for (A = [], d = X = 0; d < b.length; d++)
                            A.push(Math.ceil(b[d] ? b[d].createLabelsAndCalculateHeight() : 0)), X += A[d] + b[d].margin, M += b[d].margin;
                    else
                        A.push(Math.ceil(b[0] ? b[0].createLabelsAndCalculateHeight() : 0));
                    u.push(A);
                    if (c && 0 < c.length)
                        for (J = [], d = N = 0; d < c.length; d++)
                            J.push(Math.ceil(c[d] ? c[d].createLabelsAndCalculateHeight() : 0)), N += J[d], $ += c[d].margin;
                    else
                        J.push(Math.ceil(c[0] ?
                        ...
                        for (d = 0; d < a.length; d++) {
                            ...
                            if (b && 0 < b.length)
                                for (M = 0; M < b.length; M++)
                                    b[M] && b[M].labelAutoFit && (t = 0 > b[M].labelAngle ?
                    ...
                    if (f && 0 < f.length)
                        for (d = 0; d < f.length; d++) {
                            ...
                            if (b && 0 < b.length)
                                for (M = 0; M < b.length; M++)
                                    b[M] && b[M].labelAutoFit && (t = 0 > b[M].labelAngle ? Math.max(t, z) : 0 === b[M].labelAngle ? Math.max(t, z / 2) : t, h = 0 > b[M].labelAngle || 0 === b[M].labelAngle ? t - V : h);
                            if (c && 0 < c.length)
                                for (M = 0; M < c.length; M++)
        ...
        C.prototype.calculateBreaksSizeInValues = function () {
            for (var a = "left" === this._position || "right" === this._position ? this.lineCoordinates.height || this.chart.height : this.lineCoordinates.width || this.chart.width, f = this.scaleBreaks ? this.scaleBreaks._appliedBreaks : [], b = this.conversionParameters.pixelPerUnit || a / (this.logarithmic ? this.conversionParameters.maximum / this.conversionParameters.minimum : this.conversionParameters.maximum -
                ...
                e = c || !y(f[g].options.spacing), f[g].spacing = J(f[g].spacing, a, 8, e ? 0.1 * a : 8, e ? 0 : 3) << 0, f[g].size = 0 > f[g].spacing ? 0 : Math.abs(f[g].spacing / b), this.logarithmic && (f[g].size = Math.pow(this.logarithmBase, f[g].size));
        };
            ...
            if (this.snapToDataPoint) {
                ...
                if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
                    ...
                    if ("bottom" === this.parent._position || "top" === this.parent._position) {
                        ...
                        if ("rangeBar" === this.parent.dataSeries[q].type || "error" === this.parent.dataSeries[q].type) {
                            ...
                            l.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: m.dataPoint.y }) : y(this.options.label) ? V(m.dataPoint.y, this.valueFormatString, this.chart._cultureInfo) : this.label;
                        }
                            ...
                            l.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: u }) : y(this.options.label) ? V(u, this.valueFormatString, this.chart._cultureInfo) : this.label;
                        }
                        else
                            h = 1 === r.lineWidth % 2 ? (this.parent.convertValueToPixel(m.dataPoint.y) <<
                                0) + 0.5 : this.parent.convertValueToPixel(m.dataPoint.y) << 0, l.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: m.dataPoint.y }) : y(this.options.label) ? V(m.dataPoint.y, this.valueFormatString, this.chart._cultureInfo) : this.label;
                        b = c = h;
                        ...
                        if (u) {
                            ...
                            "dateTime" === this.parent.valueType ? l.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart,
                                axis: this.parent.options, crosshair: this.options, value: m.dataPoint.x }) : y(this.options.label) ? Aa(m.dataPoint.x, this.valueFormatString, this.chart._cultureInfo) : this.label : "number" === this.parent.valueType && (l.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: m.dataPoint.x }) : y(this.options.label) ? V(m.dataPoint.x, this.valueFormatString, this.chart._cultureInfo) : this.label);
                    ...
                    if ("rangeColumn" === this.parent.dataSeries[q].type || "rangeArea" === this.parent.dataSeries[q].type || "error" === this.parent.dataSeries[q].type || "rangeSplineArea" === this.parent.dataSeries[q].type || "candlestick" === this.parent.dataSeries[q].type || "ohlc" === this.parent.dataSeries[q].type || "boxAndWhisker" === this.parent.dataSeries[q].type) {
                        ...
                        h = 1 === r.lineWidth % 2 ? (this.parent.convertValueToPixel(m.dataPoint.y[b]) << 0) + 0.5 : this.parent.convertValueToPixel(m.dataPoint.y[b]) << 0;
                        l.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: m.dataPoint.y[b] }) : y(this.options.label) ? V(m.dataPoint.y[b], this.valueFormatString, this.chart._cultureInfo) : this.label;
                    }
                        ...
                        "waterfall" === this.parent.dataSeries[q].type ? (h = 1 === r.lineWidth % 2 ? (this.parent.convertValueToPixel(m.dataSeries.dataPointEOs[m.index].cumulativeSum) << 0) + 0.5 : this.parent.convertValueToPixel(m.dataSeries.dataPointEOs[m.index].cumulativeSum) << 0, l.text =
                            ...
                            crosshair: this.options, value: m.dataPoint.y }) : y(this.options.label) ? V(m.dataPoint.y, this.valueFormatString, this.chart._cultureInfo) : this.label);
                    e = g = h;
                    b = this.chart.plotArea.x1;
                    c = this.chart.plotArea.x2;
                    this.bounds = { x1: b, y1: e - k / 2, x2: c, y2: g + k / 2 };
                ...
                if ("xySwapped" === this.chart.plotInfo.axisPlacement)
                    if ("left" === this.parent._position || "right" === this.parent._position) {
                        ...
                        if (u) {
                            ...
                            "dateTime" === this.parent.valueType ? l.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options,
                                value: this.parent.convertPixelToValue(f) }) : y(this.options.label) ? Aa(this.parent.convertPixelToValue(f), this.valueFormatString, this.chart._cultureInfo) : this.label : "number" === this.parent.valueType && (l.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: this.parent.convertPixelToValue(f) }) : y(this.options.label) ? V(this.parent.convertPixelToValue(f), this.valueFormatString, this.chart._cultureInfo) : this.label);
                    ...
                    if (u) {
                        ...
                        "dateTime" === this.parent.valueType ? l.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: this.parent.convertPixelToValue(a) }) : y(this.options.label) ? Aa(this.parent.convertPixelToValue(a), this.valueFormatString, this.chart._cultureInfo) : this.label : "number" === this.parent.valueType && (l.text = this.labelFormatter ?
                            this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: 0 < this.parent.dataSeries.length ? this.parent.convertPixelToValue(a) : "" }) : y(this.options.label) ? V(this.parent.convertPixelToValue(a), this.valueFormatString, this.chart._cultureInfo) : this.label);
                    l.x = b - l.measureText().width / 2;
                    ...
                    l.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: this.parent.convertPixelToValue(f) }) : y(this.options.label) ? V(this.parent.convertPixelToValue(f), this.valueFormatString, this.chart._cultureInfo) : this.label, l.y = f + l.fontSize / 2 - l.measureText().height / 2 + 2, l.y -
        ...
        var O = { yScaleAnimation: function (a, f) { if (0 !== a) {
                ...
                b.restore();
            } }, easing: { linear: function (a, f, b, c) { return b * a / c + f; }, easeOutQuad: function (a, f, b, c) { return -b * (a /= c) * (a - 2) + f; }, easeOutQuart: function (a, f, b, c) { return -b * ((a = a / c - 1) * a * a * a - 1) + f; }, easeInQuad: function (a, f, b, c) { return b * (a /= c) * a + f; }, easeInQuart: function (a, f, b, c) { return b * (a /= c) * a * a * a + f; } } }, $ = { drawMarker: function (a, f, b, c, e, g, h, l) {
                if (b) {
                    var m = 1;
